                ...
                <div class="fr-tabs">
                    <ul class="fr-tabs__list" role="tablist" aria-label="[A modifier | nom du système d'onglet]">
                        <li role="presentation">
                            <button id="tabpanel-400" class="fr-tabs__tab fr-icon-checkbox-circle-line fr-tabs__tab--icon-left" tabindex="0" role="tab" aria-selected="true" aria-controls="tabpanel-400-panel">Label Tab 1</button>
                        </li>
                        <li role="presentation">
                            <button id="tabpanel-401" class="fr-tabs__tab fr-icon-checkbox-circle-line fr-tabs__tab--icon-left" tabindex="-1" role="tab" aria-selected="false" aria-controls="tabpanel-401-panel">Label Tab 2</button>
                        </li>
                        <li role="presentation">
                            <button id="tabpanel-402" class="fr-tabs__tab fr-icon-checkbox-circle-line fr-tabs__tab--icon-left" tabindex="-1" role="tab" aria-selected="false" aria-controls="tabpanel-402-panel">Label Tab 3</button>
                        </li>
                        <li role="presentation">
                            <button id="tabpanel-403" class="fr-tabs__tab fr-icon-checkbox-circle-line fr-tabs__tab--icon-left" tabindex="-1" role="tab" aria-selected="false" aria-controls="tabpanel-403-panel">Label Tab 4</button>
                        </li>
                    </ul>
                    <div id="tabpanel-400-panel" class="fr-tabs__panel fr-tabs__panel--selected" role="tabpanel" aria-labelledby="tabpanel-400" tabindex="0">
                        <!-- données de test -->
                        <div>
                    ...
                    <div id="tabpanel-401-panel" class="fr-tabs__panel" role="tabpanel" aria-labelledby="tabpanel-401" tabindex="0">
                        <!-- données de test -->
                        <div>
                    ...
                    <div id="tabpanel-402-panel" class="fr-tabs__panel" role="tabpanel" aria-labelledby="tabpanel-402" tabindex="0">
                        <!-- données de test -->
                        <div>
                    ...
                    <div id="tabpanel-403-panel" class="fr-tabs__panel" role="tabpanel" aria-labelledby="tabpanel-403" tabindex="0">
                        <!-- données de test -->
                        <div>
