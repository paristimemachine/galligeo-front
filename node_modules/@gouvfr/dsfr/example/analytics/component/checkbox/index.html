        ...
        <div class="fr-container">
            ...
            <div class="fr-mb-6v">
                <div class="fr-checkbox-group">
                    <input id="checkbox-91" type="checkbox" aria-describedby="checkbox-91-messages">
                    <label class="fr-label" for="checkbox-91">
                        label case à cocher
                    </label>
                    <div class="fr-messages-group" id="checkbox-91-messages" aria-live="assertive">
                    </div>
                </div>
            </div>
            <h3>case à cocher cochée</h3>
            <div class="fr-mb-6v">
                <div class="fr-checkbox-group">
                    <input checked id="checkbox-92" type="checkbox" aria-describedby="checkbox-92-messages">
                    <label class="fr-label" for="checkbox-92">
                        label case à cocher
                    </label>
                    <div class="fr-messages-group" id="checkbox-92-messages" aria-live="assertive">
                    </div>
                </div>
            </div>
        </div>
