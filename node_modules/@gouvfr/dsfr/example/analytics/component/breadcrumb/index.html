  ...
  const e="system",t="dark",a="dark",c=()=>{document.documentElement.setAttribute("data-fr-theme",a),document.documentElement.style.colorScheme="dark"},o=()=>{window.matchMedia("(prefers-color-scheme: dark)").matches&&c()};(()=>{if(document.documentElement.matches(":root[data-fr-theme], :root[data-fr-scheme]")){const a=(()=>{try{return"localStorage"in window&&null!==window.localStorage}catch(e){return!1}})()?localStorage.getItem("scheme"):"",r=document.documentElement.getAttribute("data-fr-scheme");switch(!0){case a===t:c();break;case a===e:o();break;case r===t:c();break;case r===e:o()}}})();
    ...
    <div class="fr-mb-12w">
        ...
        <div class="fr-container">
            <div class="fr-mt-0">
                <h2>Étiquette d’élément A</h2>
            </div>
            <nav role="navigation" class="fr-breadcrumb" aria-label="vous êtes ici :">
                <button class="fr-breadcrumb__button" aria-expanded="false" aria-controls="breadcrumb-73">Voir le fil d’Ariane</button>
                <div class="fr-collapse" id="breadcrumb-73">
                    <ol class="fr-breadcrumb__list">
                        <li>
                            <a class="fr-breadcrumb__link" href="#">Accueil</a>
                        </li>
                        <li>
                            <a class="fr-breadcrumb__link" href="[url - à modifier]">Segment 1 : lorem ipsum</a>
                        </li>
                        <li>
                            <a class="fr-breadcrumb__link" href="[url - à modifier]">Segment 2 : lorem ipsum</a>
                        </li>
                        <li>
                            <a class="fr-breadcrumb__link" href="[url - à modifier]">Segment 3 : lorem ipsum</a>
                        </li>
                        <li>
                            <a class="fr-breadcrumb__link" href="[url - à modifier]" aria-current="page">Page Actuelle</a>
                        </li>
                    </ol>
                </div>
            </nav>
            <div class="fr-mt-0">
                <h2>Étiquette d’élément BUTTON</h2>
            </div>
            <nav role="navigation" class="fr-breadcrumb" aria-label="vous êtes ici :">
                <button class="fr-breadcrumb__button" aria-expanded="false" aria-controls="breadcrumb-78">Voir le fil d’Ariane</button>
                <div class="fr-collapse" id="breadcrumb-78">
                    <ol class="fr-breadcrumb__list">
                        <li>
                            <button class="fr-breadcrumb__link" href="#">Accueil</button>
                        </li>
                        <li>
                            <button class="fr-breadcrumb__link" href="[url - à modifier]">Segment 1 : lorem ipsum</button>
                        </li>
                        <li>
                            <button class="fr-breadcrumb__link" href="[url - à modifier]">Segment 2 : lorem ipsum</button>
                        </li>
                        <li>
                            <button class="fr-breadcrumb__link" href="[url - à modifier]">Segment 3 : lorem ipsum</button>
                        </li>
                        <li>
                            <button class="fr-breadcrumb__link" href="[url - à modifier]" aria-current="page">Page Actuelle</button>
                        </li>
                    </ol>
                </div>
            </nav>
