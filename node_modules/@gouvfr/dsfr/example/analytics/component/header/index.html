  ...
  const e="system",t="dark",a="dark",c=()=>{document.documentElement.setAttribute("data-fr-theme",a),document.documentElement.style.colorScheme="dark"},o=()=>{window.matchMedia("(prefers-color-scheme: dark)").matches&&c()};(()=>{if(document.documentElement.matches(":root[data-fr-theme], :root[data-fr-scheme]")){const a=(()=>{try{return"localStorage"in window&&null!==window.localStorage}catch(e){return!1}})()?localStorage.getItem("scheme"):"",r=document.documentElement.getAttribute("data-fr-scheme");switch(!0){case a===t:c();break;case a===e:o();break;case r===t:c();break;case r===e:o()}}})();
    ...
    <div class="fr-mb-12w">
        <div class="fr-container">
            <h3>En-tête</h3>
            <div class="fr-mb-6v">
                <header role="banner" class="fr-header" id="header-94">
                        ...
                        <div class="fr-container">
                            <div class="fr-header__body-row">
                                <div class="fr-header__brand fr-enlarge-link">
                                    <div class="fr-header__brand-top">
                                        ...
                                        <div class="fr-header__navbar">
                                            <button class="fr-btn--search fr-btn" data-fr-opened="false" aria-controls="modal-96" id="button-97" title="Rechercher">
                                                Rechercher
                                            </button>
                                            <button class="fr-btn--menu fr-btn" data-fr-opened="false" aria-controls="modal-98" aria-haspopup="menu" id="button-99" title="Menu">
                                                Menu
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="fr-header__tools">
                                    ...
                                    <div class="fr-header__search fr-modal" id="modal-96">
                                        <div class="fr-container fr-container-lg--fluid">
                                            <button class="fr-btn--close fr-btn" aria-controls="modal-96" title="Fermer">
                                                Fermer
                                            </button>
                                            <div class="fr-search-bar" id="search-95" role="search">
                                                <label class="fr-label" for="search-95-input">
                                                    Rechercher
                                                </label>
                                                <input class="fr-input" aria-describedby="search-95-input-messages" placeholder="Rechercher" id="search-95-input" type="search">
                                                <div class="fr-messages-group" id="search-95-input-messages" aria-live="assertive">
                                                </div>
                                                <button class="fr-btn" id="search-btn-102" title="Rechercher">
                                                    Rechercher
                                                </button>
                                            </div>
                                        </div>
                    ...
                    <div class="fr-header__menu fr-modal" id="modal-98" aria-labelledby="button-99">
                        <div class="fr-container">
                            <button class="fr-btn--close fr-btn" aria-controls="modal-98" title="Fermer">
                                Fermer
                            </button>
                            <div class="fr-header__menu-links">
                            </div>
                            <nav class="fr-nav" id="navigation-103" role="navigation" aria-label="Menu principal">
                                <ul class="fr-nav__list">
                                    <li class="fr-nav__item">
                                        <a class="fr-nav__link" href="#" target="_self" id="nav-104">accès direct nav-104</a>
                                    </li>
                                    <li class="fr-nav__item">
                                        <a class="fr-nav__link" href="#" target="_self" id="nav-105">accès direct nav-105</a>
                                    </li>
                                    <li class="fr-nav__item">
                                        <a class="fr-nav__link" href="#" target="_self" id="nav-106">accès direct nav-106</a>
                                    </li>
                                    <li class="fr-nav__item">
                                        <a class="fr-nav__link" href="#" target="_self" id="nav-107">accès direct nav-107</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
