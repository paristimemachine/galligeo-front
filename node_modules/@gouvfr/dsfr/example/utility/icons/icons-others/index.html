...
<head>
    ...
    <title>Icônes Others - Design System</title>
            ...
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7686">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7686">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7687">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7687">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7689">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7689">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7690">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7690">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7691">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7691">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7692">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7692">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7694">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7694">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7695">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7695">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7697">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7697">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7698">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7698">
