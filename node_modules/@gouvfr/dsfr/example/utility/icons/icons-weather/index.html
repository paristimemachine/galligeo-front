...
<head>
    ...
    <title>Icônes Weather - Design System</title>
            ...
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7836">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7836">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7837">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7837">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7838">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7838">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7839">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7839">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7840">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7840">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7841">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7841">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7842">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7842">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7843">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7843">
