...
<head>
    ...
    <link href="../../dist/component/component.main.css" rel="stylesheet" file="main">
    ...
    <link href="../../dist/component/component.legacy.css" rel="stylesheet" file="legacy">
    <style>
        code[class*="language-"],
        pre[class*="language-"] {
...
<body id="top" class="fr-mb-12w">
  ...
  const e="system",t="dark",a="dark",c=()=>{document.documentElement.setAttribute("data-fr-theme",a),document.documentElement.style.colorScheme="dark"},o=()=>{window.matchMedia("(prefers-color-scheme: dark)").matches&&c()};(()=>{if(document.documentElement.matches(":root[data-fr-theme], :root[data-fr-scheme]")){const a=(()=>{try{return"localStorage"in window&&null!==window.localStorage}catch(e){return!1}})()?localStorage.getItem("scheme"):"",r=document.documentElement.getAttribute("data-fr-scheme");switch(!0){case a===t:c();break;case a===e:o();break;case r===t:c();break;case r===e:o()}}})();
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Composant (component)</h1>
    </div>
    <div class="fr-container">
        <ul class="fr-col-12">
            <li class="fr-mb-1w">
                <a href='./accordion/'>Accordéon (accordion)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./upload/'>Ajout de fichier (upload)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./alert/'>Alerte (alert)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./badge/'>Badge (badge)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./notice/'>Bandeau d&#39;information (notice)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./search/'>Barre de recherche (search)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./logo/'>Bloc marque (logo)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./button/'>Bouton (button)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./connect/'>Bouton FranceConnect (connect)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./radio/'>Bouton radio (radio)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./card/'>Carte (card)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./checkbox/'>Case à cocher (checkbox)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./quote/'>Citation (quote)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./content/'>Contenu média (content)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./header/'>En-tête (header)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./breadcrumb/'>Fil d&#39;Ariane (breadcrumb)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./form/'>Formulaire (form)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./consent/'>Gestionnaire de consentement (consent)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./stepper/'>Indicateur d&#39;étapes (stepper)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./toggle/'>Interrupteur (toggle)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./follow/'>Lettre d&#39;information et Réseaux Sociaux (follow)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./link/'>Lien (link)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./skiplink/'>Liens d&#39;évitement (skiplink)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./select/'>Liste déroulante (select)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./sidemenu/'>Menu latéral (sidemenu)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./callout/'>Mise en avant (callout)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./highlight/'>Mises en exergue (highlight)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./modal/'>Modale (modal)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./password/'>Mot de passe (password)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./navigation/'>Navigation principale (navigation)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./tab/'>Onglets (tab)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./pagination/'>Pagination (pagination)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./display/'>Paramètre d&#39;affichage (display)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./share/'>Partage (share)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./footer/'>Pied de page (footer)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./translate/'>Sélecteur de langue (translate)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./summary/'>Sommaire (summary)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./table/'>Tableaux (table)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./tag/'>Tag (tag)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./download/'>Téléchargement de fichier (download)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./transcription/'>Transcription (transcription)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./tile/'>Tuile (tile)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./input/'>Champs de saisie (input)</a>
            </li>
        </ul>
    </div>
    ...
    <script type="module" src="../../dist/component/component.module.js"></script>
    ...
    <script type="text/javascript" nomodule src="../../dist/component/component.nomodule.js"></script>
