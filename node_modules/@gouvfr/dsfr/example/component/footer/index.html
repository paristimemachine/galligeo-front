...
<head>
    ...
    <title>Pied de page - Design System</title>
...
<body id="top" class="fr-mb-12w">
  ...
  const e="system",t="dark",a="dark",c=()=>{document.documentElement.setAttribute("data-fr-theme",a),document.documentElement.style.colorScheme="dark"},o=()=>{window.matchMedia("(prefers-color-scheme: dark)").matches&&c()};(()=>{if(document.documentElement.matches(":root[data-fr-theme], :root[data-fr-scheme]")){const a=(()=>{try{return"localStorage"in window&&null!==window.localStorage}catch(e){return!1}})()?localStorage.getItem("scheme"):"",r=document.documentElement.getAttribute("data-fr-scheme");switch(!0){case a===t:c();break;case a===e:o();break;case r===t:c();break;case r===e:o()}}})();
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/pied-de-page" target="_blank">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <h3>Pied de page minimal</h3>
        <div class="fr-mb-6v">
            <footer class="fr-footer" role="contentinfo" id="footer-4496">
        ...
        <div class="fr-mb-12v">
            <section class="fr-accordion">
                <h3 class="fr-accordion__title">
                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4498">Extrait de code</button>
                </h3>
                <div class="fr-collapse" id="snippet-4498">
                    <pre class=" language-html"><code>&lt;footer class="fr-footer" role="contentinfo" id="footer-4497"&gt;
    &lt;div class="fr-container"&gt;
        &lt;div class="fr-footer__body"&gt;
            &lt;div class="fr-footer__brand fr-enlarge-link"&gt;
                &lt;a href="/" title="Retour à l’accueil du site - Nom de l’entité (ministère, secrétariat d‘état, gouvernement)"&gt;
...
&lt;/footer&gt;
        ...
        <div class="fr-mb-6v">
            <footer class="fr-footer" role="contentinfo" id="footer-4499">
        ...
        <div class="fr-mb-12v">
            <section class="fr-accordion">
                <h3 class="fr-accordion__title">
                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4501">Extrait de code</button>
                </h3>
                <div class="fr-collapse" id="snippet-4501">
                    <pre class=" language-html"><code>&lt;footer class="fr-footer" role="contentinfo" id="footer-4500"&gt;
    &lt;div class="fr-footer__top"&gt;
        &lt;div class="fr-container"&gt;
            &lt;div class="fr-grid-row fr-grid-row--start fr-grid-row--gutters"&gt;
                &lt;div class="fr-col-12 fr-col-sm-3 fr-col-md-2"&gt;
...
&lt;/footer&gt;
        ...
        <div class="fr-mb-6v">
            <footer class="fr-footer" role="contentinfo" id="footer-4502">
                <div class="fr-container">
                    <div class="fr-footer__body">
                        <div class="fr-footer__brand fr-enlarge-link">
                            <p class="fr-logo">
        ...
        <div class="fr-mb-12v">
            <section class="fr-accordion">
                <h3 class="fr-accordion__title">
                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4504">Extrait de code</button>
                </h3>
                <div class="fr-collapse" id="snippet-4504">
                    <pre class=" language-html"><code>&lt;footer class="fr-footer" role="contentinfo" id="footer-4503"&gt;
    &lt;div class="fr-container"&gt;
        &lt;div class="fr-footer__body"&gt;
            &lt;div class="fr-footer__brand fr-enlarge-link"&gt;
                &lt;p class="fr-logo"&gt;
...
&lt;/footer&gt;
        ...
        <div class="fr-mb-6v">
            <footer class="fr-footer" role="contentinfo" id="footer-4505">
                <div class="fr-container">
                    <div class="fr-footer__body">
                        <div class="fr-footer__brand fr-enlarge-link">
                            <a href="/" title="Retour à l’accueil du site - Nom de l’entité (ministère, secrétariat d‘état, gouvernement)">
        ...
        <div class="fr-mb-12v">
            <section class="fr-accordion">
                <h3 class="fr-accordion__title">
                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4507">Extrait de code</button>
                </h3>
                <div class="fr-collapse" id="snippet-4507">
                    <pre class=" language-html"><code>&lt;footer class="fr-footer" role="contentinfo" id="footer-4506"&gt;
    &lt;div class="fr-container"&gt;
        &lt;div class="fr-footer__body"&gt;
            &lt;div class="fr-footer__brand fr-enlarge-link"&gt;
                &lt;a href="/" title="Retour à l’accueil du site - Nom de l’entité (ministère, secrétariat d‘état, gouvernement)"&gt;
...
&lt;/footer&gt;
        ...
        <div class="fr-mb-6v">
            <footer class="fr-footer" role="contentinfo" id="footer-4508">
                <div class="fr-footer__top">
                    <div class="fr-container">
                        <div class="fr-grid-row fr-grid-row--start fr-grid-row--gutters">
                            <div class="fr-col-12 fr-col-sm-3 fr-col-md-2">
        ...
        <div class="fr-mb-12v">
            <section class="fr-accordion">
                <h3 class="fr-accordion__title">
                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4510">Extrait de code</button>
                </h3>
                <div class="fr-collapse" id="snippet-4510">
                    <pre class=" language-html"><code>&lt;footer class="fr-footer" role="contentinfo" id="footer-4509"&gt;
    &lt;div class="fr-footer__top"&gt;
        &lt;div class="fr-container"&gt;
            &lt;div class="fr-grid-row fr-grid-row--start fr-grid-row--gutters"&gt;
                &lt;div class="fr-col-12 fr-col-sm-3 fr-col-md-2"&gt;
