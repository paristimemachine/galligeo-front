...
<head>
    ...
    <title>Partage - Design System</title>
...
<body id="top" class="fr-mb-12w">
  ...
  const e="system",t="dark",a="dark",c=()=>{document.documentElement.setAttribute("data-fr-theme",a),document.documentElement.style.colorScheme="dark"},o=()=>{window.matchMedia("(prefers-color-scheme: dark)").matches&&c()};(()=>{if(document.documentElement.matches(":root[data-fr-theme], :root[data-fr-scheme]")){const a=(()=>{try{return"localStorage"in window&&null!==window.localStorage}catch(e){return!1}})()?localStorage.getItem("scheme"):"",r=document.documentElement.getAttribute("data-fr-scheme");switch(!0){case a===t:c();break;case a===e:o();break;case r===t:c();break;case r===e:o()}}})();
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/partage" target="_blank">Documentation</a>
    </div>
    <div class="fr-mb-12w">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4466">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4466">
...
&lt;meta name="twitter:image:alt" content="[À MODIFIER - République Française - Système de Design de l&amp;#39;État]"&gt;
                    ...
                    <div class="fr-mb-4v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4467">src/component/share/style/_setting.scss</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4467">
...
$share-icons: (
  ...
  mastodon: mastodon-line
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-share" id="share-4468">
                            <p class="fr-share__title">Partager la page</p>
                            <ul class="fr-btns-group">
                                <li>
                                    <a class="fr-btn--facebook fr-btn" id="share-4469" onclick="window.open(this.href,'Partager sur Facebook','toolbar=no,location=yes,status=no,menubar=no,scrollbars=yes,resizable=yes,width=600,height=450'); event.preventDefault();" href="https://www.facebook.com/sharer.php?u=[À MODIFIER - url de la page]" target="_blank" rel="noopener">
                                        Partager sur Facebook
                                    </a>
                                </li>
                                <li>
                                    <!-- Les paramètres de la reqûete doivent être URI-encodés (ex: encodeURIComponent() en js) -->
                                    <a class="fr-btn--twitter fr-btn" id="share-4470" onclick="window.open(this.href,'Partager sur Twitter','toolbar=no,location=yes,status=no,menubar=no,scrollbars=yes,resizable=yes,width=600,height=420'); event.preventDefault();" href="https://twitter.com/intent/tweet?url=[À MODIFIER - url de la page]&text=[À MODIFIER - titre ou texte descriptif de la page]&via=[À MODIFIER - via]&hashtags=[À MODIFIER - hashtags]" target="_blank" rel="noopener">
                                        Partager sur Twitter
                                    </a>
                                </li>
                                <li>
                                    <a class="fr-btn--linkedin fr-btn" id="share-4471" onclick="window.open(this.href,'Partager sur LinkedIn','toolbar=no,location=yes,status=no,menubar=no,scrollbars=yes,resizable=yes,width=550,height=550'); event.preventDefault();" href="https://www.linkedin.com/shareArticle?url=[À MODIFIER - url de la page]&title=[À MODIFIER - titre ou texte descriptif de la page]" target="_blank" rel="noopener">
                                        Partager sur LinkedIn
                                    </a>
                                </li>
                                <li>
                                    <a class="fr-btn--mail fr-btn" id="share-4472" href="mailto:?subject=[À MODIFIER - objet du mail]&body=[À MODIFIER - titre ou texte descriptif de la page] [À MODIFIER - url de la page]" target="_blank">
                                        Partager par email
                                    </a>
                                </li>
                                <li>
                                    <button class="fr-btn--copy fr-btn" id="share-4473" onclick="navigator.clipboard.writeText(window.location);alert('Adresse copiée dans le presse papier.');">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4480">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4480">
                                <pre class=" language-html"><code>&lt;div class="fr-share" id="share-4474"&gt;
    &lt;p class="fr-share__title"&gt;Partager la page&lt;/p&gt;
    &lt;ul class="fr-btns-group"&gt;
        &lt;li&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-share" id="share-4481">
                            <p class="fr-share__title">Partager la page</p>
                            ...
                            <ul class="fr-btns-group">
                                <li>
                                    <a class="fr-btn--facebook fr-btn" id="share-4482" aria-disabled="true" role="link">
                                        Partager sur Facebook
                                    </a>
                                </li>
                                <li>
                                    <a class="fr-btn--twitter fr-btn" id="share-4483" aria-disabled="true" role="link">
                                        Partager sur Twitter
                                    </a>
                                </li>
                                <li>
                                    <a class="fr-btn--linkedin fr-btn" id="share-4484" aria-disabled="true" role="link">
                                        Partager sur LinkedIn
                                    </a>
                                </li>
                                <li>
                                    <a class="fr-btn--mail fr-btn" id="share-4485" href="mailto:?subject=[À MODIFIER - objet du mail]&body=[À MODIFIER - titre ou texte descriptif de la page] [À MODIFIER - url de la page]" target="_blank">
                                        Partager par email
                                    </a>
                                </li>
                                <li>
                                    <button class="fr-btn--copy fr-btn" id="share-4486" onclick="navigator.clipboard.writeText(window.location);alert('Adresse copiée dans le presse papier.');">
                                        Copier dans le presse-papier
                                    </button>
                                </li>
                            </ul>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4493">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4493">
                                <pre class=" language-html"><code>&lt;div class="fr-share" id="share-4487"&gt;
    &lt;p class="fr-share__title"&gt;Partager la page&lt;/p&gt;
    &lt;p class="fr-share__text"&gt;Veuillez &lt;a href=[À MODIFIER - url page autorisation cookies]&gt;autoriser le dépôt de cookies&lt;/a&gt; pour partager sur Facebook, Twitter et LinkedIn.&lt;/p&gt;
    &lt;ul class="fr-btns-group"&gt;
        &lt;li&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4494">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4494">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4495">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4495">
                                <pre class=" language-html"><code>&lt;div class="fr-share"&gt;
    &lt;p class="fr-share__title"&gt;Partager la page&lt;/p&gt;
    &lt;p class="fr-share__text"&gt;Veuillez &lt;a href=[À MODIFIER - url page autorisation cookies]&gt;autoriser le dépôt de cookies&lt;/a&gt; pour partager sur Facebook, Twitter et LinkedIn.&lt;/p&gt;
    &lt;ul class="fr-share__group"&gt;
