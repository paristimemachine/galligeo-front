...
<head>
    ...
    <title>Fil d&#39;Ariane - Design System</title>
...
<body id="top" class="fr-mb-12w">
  ...
  const e="system",t="dark",a="dark",c=()=>{document.documentElement.setAttribute("data-fr-theme",a),document.documentElement.style.colorScheme="dark"},o=()=>{window.matchMedia("(prefers-color-scheme: dark)").matches&&c()};(()=>{if(document.documentElement.matches(":root[data-fr-theme], :root[data-fr-scheme]")){const a=(()=>{try{return"localStorage"in window&&null!==window.localStorage}catch(e){return!1}})()?localStorage.getItem("scheme"):"",r=document.documentElement.getAttribute("data-fr-scheme");switch(!0){case a===t:c();break;case a===e:o();break;case r===t:c();break;case r===e:o()}}})();
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/fil-d-ariane" target="_blank">Documentation</a>
    </div>
    <div class="fr-mb-12w">
                ...
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <nav role="navigation" class="fr-breadcrumb" aria-label="vous êtes ici :">
                            <button class="fr-breadcrumb__button" aria-expanded="false" aria-controls="breadcrumb-1993">Voir le fil d’Ariane</button>
                            <div class="fr-collapse" id="breadcrumb-1993">
                                <ol class="fr-breadcrumb__list">
                                    <li>
                                        <a class="fr-breadcrumb__link" href="/">Accueil</a>
                                    </li>
                                    <li>
                                        <a class="fr-breadcrumb__link" href="/segment-1/">Segment 1 : lorem ipsum</a>
                                    </li>
                                    <li>
                                        <a class="fr-breadcrumb__link" href="/segment-1/segment-2/">Segment 2 : lorem ipsum</a>
                                    </li>
                                    <li>
                                        <a class="fr-breadcrumb__link" href="/segment-1/segment-2/segment-3/">Segment 3 : lorem ipsum</a>
                                    </li>
                                    <li>
                                        <a class="fr-breadcrumb__link" href="/segment-1/segment-2/segment-3/segment-4/">Segment 4 : lorem ipsum dolor sit amet</a>
                                    </li>
                                    <li>
                                        <a class="fr-breadcrumb__link" href="/segment-1/segment-2/segment-3/segment-4/segment-5/">Segment 5 : lorem ipsum</a>
                                    </li>
                                    <li>
                                        <a class="fr-breadcrumb__link" href="/segment-1/segment-2/segment-3/segment-4/segment-5/segment-6/">Segment 6 : lorem ipsum</a>
                                    </li>
                                    <li>
                                        <a class="fr-breadcrumb__link" href="/segment-1/segment-2/segment-3/segment-4/segment-5/segment-6/segment-7/">Segment 7 : lorem ipsum</a>
                                    </li>
                                    <li>
                                        <a class="fr-breadcrumb__link" href="/segment-1/segment-2/segment-3/segment-4/segment-5/segment-6/segment-7/" aria-current="page">Page Actuelle</a>
                                    </li>
                                </ol>
                            </div>
                        </nav>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1995">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1995">
                                <pre class=" language-html"><code>&lt;nav role="navigation" class="fr-breadcrumb" aria-label="vous êtes ici :"&gt;
    &lt;button class="fr-breadcrumb__button" aria-expanded="false" aria-controls="breadcrumb-1994"&gt;Voir le fil d’Ariane&lt;/button&gt;
    &lt;div class="fr-collapse" id="breadcrumb-1994"&gt;
        &lt;ol class="fr-breadcrumb__list"&gt;
            &lt;li&gt;
                &lt;a class="fr-breadcrumb__link" href="/"&gt;Accueil&lt;/a&gt;
            &lt;/li&gt;
