...
<head>
    ...
    <title>Barre de recherche - Design System</title>
...
<body id="top" class="fr-mb-12w">
  ...
  const e="system",t="dark",a="dark",c=()=>{document.documentElement.setAttribute("data-fr-theme",a),document.documentElement.style.colorScheme="dark"},o=()=>{window.matchMedia("(prefers-color-scheme: dark)").matches&&c()};(()=>{if(document.documentElement.matches(":root[data-fr-theme], :root[data-fr-scheme]")){const a=(()=>{try{return"localStorage"in window&&null!==window.localStorage}catch(e){return!1}})()?localStorage.getItem("scheme"):"",r=document.documentElement.getAttribute("data-fr-scheme");switch(!0){case a===t:c();break;case a===e:o();break;case r===t:c();break;case r===e:o()}}})();
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/barre-de-recherche" target="_blank">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-search-bar" id="search-488" role="search">
                            <label class="fr-label" for="search-488-input">
                                Rechercher
                            </label>
                            <input class="fr-input" aria-describedby="search-488-input-messages" placeholder="Rechercher" id="search-488-input" type="search">
                            <div class="fr-messages-group" id="search-488-input-messages" aria-live="assertive">
                            </div>
                            <button class="fr-btn" id="search-btn-489" title="Rechercher">
                                Rechercher
                            </button>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-492">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-492">
                                <pre class=" language-html"><code>&lt;div class="fr-search-bar" id="search-490" role="search"&gt;
    &lt;label class="fr-label" for="search-490-input"&gt;
        Rechercher
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="search-490-input-messages" placeholder="Rechercher" id="search-490-input" type="search"&gt;
    &lt;div class="fr-messages-group" id="search-490-input-messages" aria-live="assertive"&gt;
    &lt;/div&gt;
    &lt;button class="fr-btn" id="search-btn-491" title="Rechercher"&gt;
        Rechercher
    &lt;/button&gt;
&lt;/div&gt;
</code></pre>
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-search-bar fr-search-bar--lg" id="search-493" role="search">
                            ...
                            <button class="fr-btn" id="search-btn-494">
                                Rechercher
                            </button>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-497">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-497">
                                <pre class=" language-html"><code>&lt;div class="fr-search-bar fr-search-bar--lg" id="search-495" role="search"&gt;
    &lt;label class="fr-label" for="search-495-input"&gt;
        Rechercher
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="search-495-input-messages" placeholder="Rechercher" id="search-495-input" type="search"&gt;
    &lt;div class="fr-messages-group" id="search-495-input-messages" aria-live="assertive"&gt;
    &lt;/div&gt;
    &lt;button class="fr-btn" id="search-btn-496"&gt;
        Rechercher
    &lt;/button&gt;
&lt;/div&gt;
</code></pre>
