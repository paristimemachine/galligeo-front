                            ...
                            <fieldset class="fr-fieldset" id="text" aria-labelledby="text-legend text-messages">
                                ...
                                <div class="fr-fieldset__element">
                                    <div class="fr-input-group">
                                        ...
                                        <div class="fr-messages-group" id="text-1-messages" aria-live="assertive">
                                        </div>
                                    </div>
                                </div>
                                <div class="fr-fieldset__element">
                                    <div class="fr-input-group">
                                        ...
                                        <div class="fr-messages-group" id="text-2-messages" aria-live="assertive">
                                        </div>
                                    </div>
                                </div>
                                <div class="fr-fieldset__element">
                                    <div class="fr-input-group">
                                        ...
                                        <div class="fr-messages-group" id="text-3-messages" aria-live="assertive">
                                        </div>
                                    </div>
                                </div>
                                <div class="fr-messages-group" id="text-messages" aria-live="assertive">
                                </div>
                            </fieldset>
                        </div>
                        <div class="fr-mb-12v">
                            ...
                            <fieldset class="fr-fieldset" id="checkbox" aria-labelledby="checkbox-legend checkbox-messages">
                                ...
                                <div class="fr-fieldset__element">
                                    <div class="fr-checkbox-group">
                                        ...
                                        <div class="fr-messages-group" id="checkbox-1-messages" aria-live="assertive">
                                        </div>
                                    </div>
                                </div>
                                <div class="fr-fieldset__element">
                                    <div class="fr-checkbox-group">
                                        ...
                                        <div class="fr-messages-group" id="checkbox-2-messages" aria-live="assertive">
                                        </div>
                                    </div>
                                </div>
                                <div class="fr-fieldset__element">
                                    <div class="fr-checkbox-group">
                                        ...
                                        <div class="fr-messages-group" id="checkbox-3-messages" aria-live="assertive">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <fieldset class="fr-fieldset" id="checkbox-inline" aria-labelledby="checkbox-inline-legend checkbox-inline-messages">
                                ...
                                <div class="fr-fieldset__element fr-fieldset__element--inline">
                                    <div class="fr-checkbox-group">
                                        ...
                                        <div class="fr-messages-group" id="checkbox-inline-1-messages" aria-live="assertive">
                                        </div>
                                    </div>
                                </div>
                                <div class="fr-fieldset__element fr-fieldset__element--inline">
                                    <div class="fr-checkbox-group">
                                        ...
                                        <div class="fr-messages-group" id="checkbox-inline-2-messages" aria-live="assertive">
                                        </div>
                                    </div>
                                </div>
                                <div class="fr-fieldset__element fr-fieldset__element--inline">
                                    <div class="fr-checkbox-group">
                                        ...
                                        <div class="fr-messages-group" id="checkbox-inline-3-messages" aria-live="assertive">
                                        </div>
                                    </div>
                                </div>
                                <div class="fr-messages-group" id="checkbox-inline-messages" aria-live="assertive">
                                </div>
                            </fieldset>
                        </div>
                        <div class="fr-mb-12v">
                            ...
                            <fieldset class="fr-fieldset fr-fieldset--error" id="checkbox-error" role="group" aria-labelledby="checkbox-error-legend checkbox-error-messages">
                                ...
                                <div class="fr-fieldset__element">
                                    <div class="fr-checkbox-group">
                                        ...
                                        <div class="fr-messages-group" id="checkbox-error-1-messages" aria-live="assertive">
                                        </div>
                                    </div>
                                </div>
                                <div class="fr-fieldset__element">
                                    <div class="fr-checkbox-group">
                                        ...
                                        <div class="fr-messages-group" id="checkbox-error-2-messages" aria-live="assertive">
                                        </div>
                                    </div>
                                </div>
                                <div class="fr-fieldset__element">
                                    <div class="fr-checkbox-group">
                                        ...
                                        <div class="fr-messages-group" id="checkbox-error-3-messages" aria-live="assertive">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <fieldset class="fr-fieldset" id="text-disabled" disabled aria-labelledby="text-disabled-legend text-disabled-messages">
                                ...
                                <div class="fr-fieldset__element">
                                    <div class="fr-input-group">
                                        ...
                                        <div class="fr-messages-group" id="text-disabled-1-messages" aria-live="assertive">
                                        </div>
                                    </div>
                                </div>
                                <div class="fr-fieldset__element">
                                    <div class="fr-input-group">
                                        ...
                                        <div class="fr-messages-group" id="text-disabled-2-messages" aria-live="assertive">
                                        </div>
                                    </div>
                                </div>
                                <div class="fr-fieldset__element">
                                    <div class="fr-input-group">
                                        ...
                                        <div class="fr-messages-group" id="text-disabled-3-messages" aria-live="assertive">
                                        </div>
                                    </div>
                                </div>
                                <div class="fr-messages-group" id="text-disabled-messages" aria-live="assertive">
                                </div>
                            </fieldset>
                        </div>
                        <div class="fr-mb-12v">
                            ...
                            <fieldset class="fr-fieldset" id="checkbox-disabled" disabled aria-labelledby="checkbox-disabled-legend checkbox-disabled-messages">
                                ...
                                <div class="fr-fieldset__element">
                                    <div class="fr-checkbox-group">
                                        ...
                                        <div class="fr-messages-group" id="checkbox-disabled-1-messages" aria-live="assertive">
                                        </div>
                                    </div>
                                </div>
                                <div class="fr-fieldset__element">
                                    <div class="fr-checkbox-group">
                                        ...
                                        <div class="fr-messages-group" id="checkbox-disabled-2-messages" aria-live="assertive">
                                        </div>
                                    </div>
                                </div>
                                <div class="fr-fieldset__element">
                                    <div class="fr-checkbox-group">
                                        ...
                                        <div class="fr-messages-group" id="checkbox-disabled-3-messages" aria-live="assertive">
                                        </div>
                                    </div>
                                </div>
                                <div class="fr-messages-group" id="checkbox-disabled-messages" aria-live="assertive">
                                </div>
                            </fieldset>
                        </div>
                        <div class="fr-mb-12v">
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2007">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-2007">
                                    <pre class=" language-html"><code>&lt;button class="fr-btn" title="Envoyer le formulaire" type="submit"&gt;
    Envoyer
&lt;/button&gt;
</code></pre>
                                </div>
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2008">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-2008">
                                    <pre class=" language-html"><code>&lt;input class="fr-btn" value="Envoyer" title="Envoyer le formulaire" type="submit"&gt;
&lt;/input&gt;
</code></pre>
                                </div>
                            </section>
