...
<head>
    ...
    <title>Formulaire - Design System</title>
                                ...
                                <fieldset class="fr-fieldset">
                                    ...
                                    <div class="fr-fieldset__content">
                                        <div class="fr-input-group">
                                            ...
                                            <div class="fr-messages-group" id="text-deprecated-1-messages" aria-live="assertive">
                                            </div>
                                        </div>
                                        <div class="fr-input-group">
                                            ...
                                            <div class="fr-messages-group" id="text-deprecated-2-messages" aria-live="assertive">
                                            </div>
                                        </div>
                                        <div class="fr-input-group">
                                            ...
                                            <div class="fr-messages-group" id="text-deprecated-3-messages" aria-live="assertive">
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset class="fr-fieldset">
                                    ...
                                    <div class="fr-fieldset__content">
                                        <div class="fr-checkbox-group">
                                            ...
                                            <div class="fr-messages-group" id="checkbox-deprecated-1-messages" aria-live="assertive">
                                            </div>
                                        </div>
                                        <div class="fr-checkbox-group">
                                            ...
                                            <div class="fr-messages-group" id="checkbox-deprecated-2-messages" aria-live="assertive">
                                            </div>
                                        </div>
                                        <div class="fr-checkbox-group">
                                            ...
                                            <div class="fr-messages-group" id="checkbox-deprecated-3-messages" aria-live="assertive">
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
...
&lt;/div&gt;
                                ...
                                <fieldset class="fr-fieldset fr-fieldset--inline">
                                    ...
                                    <div class="fr-fieldset__content">
                                        <div class="fr-checkbox-group">
                                            ...
                                            <div class="fr-messages-group" id="checkbox-inline-deprecated-1-messages" aria-live="assertive">
                                            </div>
                                        </div>
                                        <div class="fr-checkbox-group">
                                            ...
                                            <div class="fr-messages-group" id="checkbox-inline-deprecated-2-messages" aria-live="assertive">
                                            </div>
                                        </div>
                                        <div class="fr-checkbox-group">
                                            ...
                                            <div class="fr-messages-group" id="checkbox-inline-deprecated-3-messages" aria-live="assertive">
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2013">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-2013">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--inline"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkbox-inline-deprecated-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2014">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-2014">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--error" aria-labelledby="radio-error-deprecated-legend radio-error-deprecated-desc-error" role="group"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-error-deprecated-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2015">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-2015">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-disabled-deprecated-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                                ...
                                <fieldset class="fr-fieldset fr-fieldset--error" aria-labelledby="checkbox-error-deprecated-legend checkbox-error-deprecated-desc-error" role="group">
                                    ...
                                    <div class="fr-fieldset__content">
                                        <div class="fr-checkbox-group">
                                            ...
                                            <div class="fr-messages-group" id="checkbox-error-deprecated-1-messages" aria-live="assertive">
                                            </div>
                                        </div>
                                        <div class="fr-checkbox-group">
                                            ...
                                            <div class="fr-messages-group" id="checkbox-error-deprecated-2-messages" aria-live="assertive">
                                            </div>
                                        </div>
                                        <div class="fr-checkbox-group">
                                            ...
                                            <div class="fr-messages-group" id="checkbox-error-deprecated-3-messages" aria-live="assertive">
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2016">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-2016">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--error" aria-labelledby="checkbox-error-deprecated-legend checkbox-error-deprecated-desc-error" role="group"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkbox-error-deprecated-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                                ...
                                <fieldset class="fr-fieldset">
                                    ...
                                    <div class="fr-fieldset__content">
                                        <div class="fr-input-group fr-input-group--disabled">
                                            ...
                                            <div class="fr-messages-group" id="text-disabled-deprecated-1-messages" aria-live="assertive">
                                            </div>
                                        </div>
                                        <div class="fr-input-group fr-input-group--disabled">
                                            ...
                                            <div class="fr-messages-group" id="text-disabled-deprecated-2-messages" aria-live="assertive">
                                            </div>
                                        </div>
                                        <div class="fr-input-group fr-input-group--disabled">
                                            ...
                                            <div class="fr-messages-group" id="text-disabled-deprecated-3-messages" aria-live="assertive">
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2017">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-2017">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend" id='text-disabled-deprecated-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2018">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-2018">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-disabled-deprecated-legend'&gt;
            Légende pour l’ensemble de champs
                                ...
                                <fieldset class="fr-fieldset">
                                    ...
                                    <div class="fr-fieldset__content">
                                        <div class="fr-checkbox-group">
                                            ...
                                            <div class="fr-messages-group" id="checkbox-disabled-deprecated-1-messages" aria-live="assertive">
                                            </div>
                                        </div>
                                        <div class="fr-checkbox-group">
                                            ...
                                            <div class="fr-messages-group" id="checkbox-disabled-deprecated-2-messages" aria-live="assertive">
                                            </div>
                                        </div>
                                        <div class="fr-checkbox-group">
                                            ...
                                            <div class="fr-messages-group" id="checkbox-disabled-deprecated-3-messages" aria-live="assertive">
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
