...
<head>
    ...
    <title>Téléchargement de fichier - Design System</title>
...
<body id="top" class="fr-mb-12w">
  ...
  const e="system",t="dark",a="dark",c=()=>{document.documentElement.setAttribute("data-fr-theme",a),document.documentElement.style.colorScheme="dark"},o=()=>{window.matchMedia("(prefers-color-scheme: dark)").matches&&c()};(()=>{if(document.documentElement.matches(":root[data-fr-theme], :root[data-fr-scheme]")){const a=(()=>{try{return"localStorage"in window&&null!==window.localStorage}catch(e){return!1}})()?localStorage.getItem("scheme"):"",r=document.documentElement.getAttribute("data-fr-scheme");switch(!0){case a===t:c();break;case a===e:o();break;case r===t:c();break;case r===e:o()}}})();
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <p>Ce composant permet aux utilisateurs de télécharger un ou plusieurs fichiers.</p>
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/telechargement-de-fichier" target="_blank">Documentation</a>
    </div>
    <div class="fr-mb-12w">
            ...
            <div class="fr-accordions-group">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="download-4554">Lien de téléchargement</button>
                    </h3>
                    <div class="fr-collapse" id="download-4554">
                        <div class="fr-mt-0">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4555">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-4555">
...
&lt;/div&gt;
                ...
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="download-4556">Groupe de liens</button>
                    </h3>
                    <div class="fr-collapse" id="download-4556">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4557">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-4557">
                        ...
                        <div>
                            <div class="fr-container">
                                ...
                                <div class="fr-mb-12v">
                                    <section class="fr-accordion">
                                        <h3 class="fr-accordion__title">
                                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4558">Extrait de code</button>
                                        </h3>
                                        <div class="fr-collapse" id="snippet-4558">
...
&lt;/div&gt;
                ...
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="download-4559">Carte de téléchargement</button>
                    </h3>
                    <div class="fr-collapse" id="download-4559">
                        <div class="fr-mt-0">
                        ...
                        <div>
                            <div class="fr-container">
                                ...
                                <div class="fr-mb-12v">
                                    <section class="fr-accordion">
                                        <h3 class="fr-accordion__title">
                                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4560">Extrait de code</button>
                                        </h3>
                                        <div class="fr-collapse" id="snippet-4560">
...
&lt;/div&gt;
                ...
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="download-4561">Groupe de cartes</button>
                    </h3>
                    <div class="fr-collapse" id="download-4561">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4562">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-4562">
...
&lt;/div&gt;
                ...
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="download-4563">Fichier en langue étrangère</button>
                    </h3>
                    <div class="fr-collapse" id="download-4563">
                        <div class="fr-mt-0">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4564">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-4564">
                                    <pre class=" language-html"><code>&lt;div class="fr-download"&gt;
    &lt;h3&gt;
        &lt;a href="[À MODIFIER - ../../../example/img/image.jpg]" download hreflang="en" class="fr-download__link"&gt;Télécharger le document lorem ipsum sit dolores amet
            &lt;span class="fr-download__detail"&gt;
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4565">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-4565">
                                    <pre class=" language-html"><code>&lt;div class="fr-download fr-enlarge-link fr-download--card"&gt;
    &lt;h3&gt;
        &lt;a href="[À MODIFIER - ../../../example/img/image.jpg]" download hreflang="en" class="fr-download__link"&gt;Télécharger le document lorem ipsum sit dolores amet
            &lt;span class="fr-download__detail"&gt;
...
&lt;/div&gt;
                ...
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="download-4566">Utilitaire js</button>
                    </h3>
                    <div class="fr-collapse" id="download-4566">
                        <div class="fr-mt-0">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4567">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-4567">
                                    <pre class=" language-html"><code>&lt;div class="fr-download"&gt;
    &lt;h3&gt;
        &lt;a href="../../../dist/favicon/favicon.ico" data-fr-assess-file download class="fr-download__link"&gt;Télécharger le document lorem ipsum sit dolores amet
            &lt;span class="fr-download__detail"&gt;
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4568">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-4568">
                                    <pre class=" language-html"><code>&lt;div class="fr-download fr-enlarge-link fr-download--card"&gt;
    &lt;h3&gt;
        &lt;a href="../../../dist/favicon/favicon.ico" data-fr-assess-file download class="fr-download__link"&gt;Télécharger le document lorem ipsum sit dolores amet
            &lt;span class="fr-download__detail"&gt;
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4569">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-4569">
                                    <pre class=" language-html"><code>&lt;div class="fr-download"&gt;
    &lt;h3&gt;
        &lt;a href="../../../dist/favicon/favicon.ico" data-fr-assess-file download hreflang="en" class="fr-download__link"&gt;Télécharger le document lorem ipsum sit dolores amet
            &lt;span class="fr-download__detail"&gt;
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4570">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-4570">
