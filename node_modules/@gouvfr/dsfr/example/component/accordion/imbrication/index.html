                    ...
                    <div class="fr-mb-6v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-421">Intitulé accordéon</button>
                            </h3>
                            <div class="fr-collapse" id="accordion-421">
                                <section class="fr-accordion">
                                    <h3 class="fr-accordion__title">
                                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-422">Intitulé accordéon</button>
                                    </h3>
                                    <div class="fr-collapse" id="accordion-422">
                                        <!-- données de test -->
                                        <div>
