...
<head>
    ...
    <title>Accordéon - Design System</title>
...
<body id="top" class="fr-mb-12w">
  ...
  const e="system",t="dark",a="dark",c=()=>{document.documentElement.setAttribute("data-fr-theme",a),document.documentElement.style.colorScheme="dark"},o=()=>{window.matchMedia("(prefers-color-scheme: dark)").matches&&c()};(()=>{if(document.documentElement.matches(":root[data-fr-theme], :root[data-fr-scheme]")){const a=(()=>{try{return"localStorage"in window&&null!==window.localStorage}catch(e){return!1}})()?localStorage.getItem("scheme"):"",r=document.documentElement.getAttribute("data-fr-scheme");switch(!0){case a===t:c();break;case a===e:o();break;case r===t:c();break;case r===e:o()}}})();
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/accordeon" target="_blank">Documentation</a>
    </div>
    <div class="fr-mb-12w">
            ...
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-405">Intitulé accordéon</button>
                            </h3>
                            <div class="fr-collapse" id="accordion-405">
                                <!-- données de test -->
                                <div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-407">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-407">
                                <pre class=" language-html"><code>&lt;section class="fr-accordion"&gt;
    &lt;h3 class="fr-accordion__title"&gt;
        &lt;button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-406"&gt;Intitulé accordéon&lt;/button&gt;
    &lt;/h3&gt;
    &lt;div class="fr-collapse" id="accordion-406"&gt;
        &lt;!-- données de test --&gt;
    &lt;/div&gt;
&lt;/section&gt;
</code></pre>
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-accordions-group">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-408">Intitulé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-408">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-409">Intitulé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-409">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <img class="fr-responsive-img" src="../../../example/img/placeholder.16x9.png" alt="" />
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-410">Intitulé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-410">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing, <a href="test" target="_blank">link test</a> incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</p>
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-411">Intitulé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-411">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing, <a href="test" target="_blank">link test</a> incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</p>
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-412">Intitulé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-412">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <img class="fr-responsive-img" src="../../../example/img/placeholder.16x9.png" alt="" />
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-413">Intitulé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-413">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing, <a href="test" target="_blank">link test</a> incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</p>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-420">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-420">
                                <pre class=" language-html"><code>&lt;div class="fr-accordions-group"&gt;
    &lt;section class="fr-accordion"&gt;
        &lt;h3 class="fr-accordion__title"&gt;
            &lt;button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-414"&gt;Intitulé accordéon&lt;/button&gt;
        &lt;/h3&gt;
        &lt;div class="fr-collapse" id="accordion-414"&gt;
            &lt;!-- données de test --&gt;
        &lt;/div&gt;
    &lt;/section&gt;
    &lt;section class="fr-accordion"&gt;
        &lt;h3 class="fr-accordion__title"&gt;
            &lt;button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-415"&gt;Intitulé accordéon&lt;/button&gt;
        &lt;/h3&gt;
        &lt;div class="fr-collapse" id="accordion-415"&gt;
            &lt;!-- données de test --&gt;
        &lt;/div&gt;
    &lt;/section&gt;
    &lt;section class="fr-accordion"&gt;
        &lt;h3 class="fr-accordion__title"&gt;
            &lt;button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-416"&gt;Intitulé accordéon&lt;/button&gt;
        &lt;/h3&gt;
        &lt;div class="fr-collapse" id="accordion-416"&gt;
            &lt;!-- données de test --&gt;
        &lt;/div&gt;
    &lt;/section&gt;
    &lt;section class="fr-accordion"&gt;
        &lt;h3 class="fr-accordion__title"&gt;
            &lt;button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-417"&gt;Intitulé accordéon&lt;/button&gt;
        &lt;/h3&gt;
        &lt;div class="fr-collapse" id="accordion-417"&gt;
            &lt;!-- données de test --&gt;
        &lt;/div&gt;
    &lt;/section&gt;
    &lt;section class="fr-accordion"&gt;
        &lt;h3 class="fr-accordion__title"&gt;
            &lt;button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-418"&gt;Intitulé accordéon&lt;/button&gt;
        &lt;/h3&gt;
        &lt;div class="fr-collapse" id="accordion-418"&gt;
            &lt;!-- données de test --&gt;
        &lt;/div&gt;
    &lt;/section&gt;
    &lt;section class="fr-accordion"&gt;
        &lt;h3 class="fr-accordion__title"&gt;
            &lt;button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-419"&gt;Intitulé accordéon&lt;/button&gt;
        &lt;/h3&gt;
        &lt;div class="fr-collapse" id="accordion-419"&gt;
            &lt;!-- données de test --&gt;
        &lt;/div&gt;
    &lt;/section&gt;
&lt;/div&gt;
