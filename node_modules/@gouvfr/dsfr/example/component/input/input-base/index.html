...
<head>
    ...
    <title>Champs de saisie - Design System</title>
    ...
    <link href="../../../../dist/component/input/input-base/input-base.main.css" rel="stylesheet" file="main">
    ...
    <link href="../../../../dist/component/input/input-base/input-base.legacy.css" rel="stylesheet" file="legacy">
...
<body id="top" class="fr-mb-12w">
  ...
  const e="system",t="dark",a="dark",c=()=>{document.documentElement.setAttribute("data-fr-theme",a),document.documentElement.style.colorScheme="dark"},o=()=>{window.matchMedia("(prefers-color-scheme: dark)").matches&&c()};(()=>{if(document.documentElement.matches(":root[data-fr-theme], :root[data-fr-scheme]")){const a=(()=>{try{return"localStorage"in window&&null!==window.localStorage}catch(e){return!1}})()?localStorage.getItem("scheme"):"",r=document.documentElement.getAttribute("data-fr-scheme");switch(!0){case a===t:c();break;case a===e:o();break;case r===t:c();break;case r===e:o()}}})();
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Champs de saisie (input-base)</h1>
        <p>Les champs permettent à un utilisateur d'entrer du contenu et données.</p>
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/champ-de-saisie" target="_blank">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    <h3>Champs de type &#34;text&#34;</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4591">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4591">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4592">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4592">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-number"&gt;
        Libellé champs de saisie
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4593">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4593">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-search"&gt;
        Libellé champs de saisie
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4594">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4594">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-date"&gt;
        Libellé champs de saisie
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4595">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4595">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="textarea"&gt;
        Libellé champs de saisie
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4596">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4596">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-password"&gt;
        Libellé champs de saisie
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4597">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4597">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-button"&gt;
        Libellé champs de saisie
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4598">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4598">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-placeholder"&gt;
        Libellé champs de saisie
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Champs avec valeur initiale</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-input-group">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4599">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4599">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-value"&gt;
        Libellé champs de saisie
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Champs avec icône personalisée</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-input-group">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4600">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4600">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-icon"&gt;
        Libellé champs de saisie
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4601">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4601">
...
&lt;/div&gt;
                    ...
                    <h3>Champs avec texte additionnel</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-input-group">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4602">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4602">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-hint"&gt;
        Libellé champs de saisie
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Champs valide avec texte de succès</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4603">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4603">
...
&lt;/div&gt;
                    ...
                    <h3>Champs en erreur avec texte d&#39;erreur</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4604">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4604">
