...
<head>
    ...
    <title>Modèle de champ email - Design System</title>
...
<body id="top" class="fr-mb-12w">
  ...
  const e="system",t="dark",a="dark",c=()=>{document.documentElement.setAttribute("data-fr-theme",a),document.documentElement.style.colorScheme="dark"},o=()=>{window.matchMedia("(prefers-color-scheme: dark)").matches&&c()};(()=>{if(document.documentElement.matches(":root[data-fr-theme], :root[data-fr-scheme]")){const a=(()=>{try{return"localStorage"in window&&null!==window.localStorage}catch(e){return!1}})()?localStorage.getItem("scheme"):"",r=document.documentElement.getAttribute("data-fr-scheme");switch(!0){case a===t:c();break;case a===e:o();break;case r===t:c();break;case r===e:o()}}})();
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Modèle de champ email (input-email)</h1>
    </div>
    <div class="fr-mb-12w">
                ...
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group">
                            <label class="fr-label" for="email-4619">
                                Adresse électronique
                                <span class="fr-hint-text">Format attendu : nom@domaine.fr</span>
                            </label>
                            <input class="fr-input" spellcheck="false" autocomplete="email" aria-describedby="email-4619-messages" id="email-4619" type="email">
                            <div class="fr-messages-group" id="email-4619-messages" aria-live="assertive">
                            </div>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group fr-input-group--error">
                            <label class="fr-label" for="email-4622">
                                Adresse électronique
                                <span class="fr-hint-text">Format attendu : nom@domaine.fr</span>
                            </label>
                            <input class="fr-input" spellcheck="false" autocomplete="email" aria-describedby="email-4622-messages" id="email-4622" type="email">
                            <div class="fr-messages-group" id="email-4622-messages" aria-live="assertive">
                                <p class="fr-message fr-message--error" id="email-4622-message-error">Le format de l’adresse electronique saisie n’est pas valide. Le format attendu est : nom@exemple.org</p>
                            </div>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group">
                            <label class="fr-label" for="email-4625">
                                Adresse électronique
                            ...
                            <input class="fr-input" spellcheck="false" autocomplete="email" aria-describedby="email-4625-messages" id="email-4625" type="email">
                            <div class="fr-messages-group" id="email-4625-messages" aria-live="assertive">
                            </div>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4627">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4627">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group fr-input-group--error">
                            <label class="fr-label" for="email-4628">
                                Adresse électronique
                                <span class="fr-hint-text">Cette adresse est utilisée uniquement pour la connexion au service. Format attendu : nom@domaine.fr</span>
                            </label>
                            <input class="fr-input" spellcheck="false" autocomplete="email" aria-describedby="email-4628-messages" id="email-4628" type="email">
                            <div class="fr-messages-group" id="email-4628-messages" aria-live="assertive">
                                <p class="fr-message fr-message--error" id="email-4628-message-error">Le format de l’adresse electronique saisie n’est pas valide. Le format attendu est : nom@exemple.org</p>
                            </div>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
