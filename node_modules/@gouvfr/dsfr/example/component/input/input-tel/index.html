...
<head>
    ...
    <title>Modèle de champ numéro de téléphone - Design System</title>
...
<body id="top" class="fr-mb-12w">
  ...
  const e="system",t="dark",a="dark",c=()=>{document.documentElement.setAttribute("data-fr-theme",a),document.documentElement.style.colorScheme="dark"},o=()=>{window.matchMedia("(prefers-color-scheme: dark)").matches&&c()};(()=>{if(document.documentElement.matches(":root[data-fr-theme], :root[data-fr-scheme]")){const a=(()=>{try{return"localStorage"in window&&null!==window.localStorage}catch(e){return!1}})()?localStorage.getItem("scheme"):"",r=document.documentElement.getAttribute("data-fr-scheme");switch(!0){case a===t:c();break;case a===e:o();break;case r===t:c();break;case r===e:o()}}})();
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Modèle de champ numéro de téléphone (input-tel)</h1>
    </div>
    <div class="fr-mb-12w">
                ...
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group">
                            <label class="fr-label" for="tel-4631">
                                Numéro de téléphone
                                <span class="fr-hint-text">Format attendu : (+33) 1 22 33 44 55</span>
                            </label>
                            <input class="fr-input" autocomplete="tel" aria-describedby="tel-4631-messages" id="tel-4631" type="tel">
                            <div class="fr-messages-group" id="tel-4631-messages" aria-live="assertive">
                            </div>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4633">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4633">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="tel-4632"&gt;
        Numéro de téléphone
        &lt;span class="fr-hint-text"&gt;Format attendu : (+33) 1 22 33 44 55&lt;/span&gt;
    &lt;/label&gt;
    &lt;input class="fr-input" autocomplete="tel" aria-describedby="tel-4632-messages" id="tel-4632" type="tel"&gt;
    &lt;div class="fr-messages-group" id="tel-4632-messages" aria-live="assertive"&gt;
    &lt;/div&gt;
&lt;/div&gt;
</code></pre>
                            </div>
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group fr-input-group--error">
                            <label class="fr-label" for="tel-4634">
                                Numéro de téléphone
                                <span class="fr-hint-text">Format attendu : (+33) 1 22 33 44 55</span>
                            </label>
                            <input class="fr-input" autocomplete="tel" aria-describedby="tel-4634-messages" id="tel-4634" type="tel">
                            <div class="fr-messages-group" id="tel-4634-messages" aria-live="assertive">
                                <p class="fr-message fr-message--error" id="tel-4634-message-error">Le format de numéro de téléphone saisie n’est pas valide. Le format attendu est : (+33) 2 43 55 55 55</p>
                            </div>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4636">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4636">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--error"&gt;
    &lt;label class="fr-label" for="tel-4635"&gt;
        Numéro de téléphone
        &lt;span class="fr-hint-text"&gt;Format attendu : (+33) 1 22 33 44 55&lt;/span&gt;
    &lt;/label&gt;
    &lt;input class="fr-input" autocomplete="tel" aria-describedby="tel-4635-messages" id="tel-4635" type="tel"&gt;
    &lt;div class="fr-messages-group" id="tel-4635-messages" aria-live="assertive"&gt;
        &lt;p class="fr-message fr-message--error" id="tel-4635-message-error"&gt;Le format de numéro de téléphone saisie n’est pas valide. Le format attendu est : (+33) 2 43 55 55 55&lt;/p&gt;
    &lt;/div&gt;
&lt;/div&gt;
</code></pre>
                            </div>
