...
<head>
    ...
    <title>Bandeau d&#39;information - Design System</title>
...
<body id="top" class="fr-mb-12w">
  ...
  const e="system",t="dark",a="dark",c=()=>{document.documentElement.setAttribute("data-fr-theme",a),document.documentElement.style.colorScheme="dark"},o=()=>{window.matchMedia("(prefers-color-scheme: dark)").matches&&c()};(()=>{if(document.documentElement.matches(":root[data-fr-theme], :root[data-fr-scheme]")){const a=(()=>{try{return"localStorage"in window&&null!==window.localStorage}catch(e){return!1}})()?localStorage.getItem("scheme"):"",r=document.documentElement.getAttribute("data-fr-scheme");switch(!0){case a===t:c();break;case a===e:o();break;case r===t:c();break;case r===e:o()}}})();
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Bandeau d&#39;information (notice)</h1>
        ...
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/bandeau-d-information-importante" target="_blank">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-mt-0">
        ...
        <div class="fr-container">
            <h4 class="fr-h4">Bandeau d&#39;information simple</h4>
        </div>
        <div class="fr-mb-6v">
            ...
            <div class="fr-container">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-484">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-484">
...
&lt;/div&gt;
        ...
        <div class="fr-container">
            <h4 class="fr-h4">Bandeau d&#39;information avec bouton fermer</h4>
        </div>
        <div class="fr-mb-6v">
            <div class="fr-notice fr-notice--info">
                <div class="fr-container">
        ...
        <div class="fr-mb-12v">
            <div class="fr-container">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-485">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-485">
                        <pre class=" language-html"><code>&lt;div class="fr-notice fr-notice--info"&gt;
    &lt;div class="fr-container"&gt;
        &lt;div class="fr-notice__body"&gt;
            &lt;p class="fr-notice__title"&gt;Titre du bandeau&lt;/p&gt;
...
&lt;/div&gt;
        ...
        <div class="fr-container">
            <h4 class="fr-h4">Bandeau d&#39;information avec lien</h4>
        </div>
        <div class="fr-mb-6v">
            <div class="fr-notice fr-notice--info">
                <div class="fr-container">
        ...
        <div class="fr-mb-12v">
            <div class="fr-container">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-486">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-486">
                        <pre class=" language-html"><code>&lt;div class="fr-notice fr-notice--info"&gt;
    &lt;div class="fr-container"&gt;
        &lt;div class="fr-notice__body"&gt;
            &lt;p class="fr-notice__title"&gt;Titre du bandeau, &lt;a href='#' rel='noopener' target='_blank'&gt;lien au fil du texte&lt;/a&gt;
...
&lt;/div&gt;
        ...
        <div class="fr-container">
            <h4 class="fr-h4">Bandeau d&#39;information titre long</h4>
        </div>
        <div class="fr-mb-6v">
            <div class="fr-notice fr-notice--info">
                <div class="fr-container">
        ...
        <div class="fr-mb-12v">
            <div class="fr-container">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-487">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-487">
                        <pre class=" language-html"><code>&lt;div class="fr-notice fr-notice--info"&gt;
    &lt;div class="fr-container"&gt;
        &lt;div class="fr-notice__body"&gt;
            &lt;p class="fr-notice__title"&gt;Titre de bandeau très long, pour tester le comportement du composant avec un texte très long, et un &lt;a href='#' rel='noopener' target='_blank'&gt;lien au fil du texte&lt;/a&gt; lorem ipsum dolor sit lorem ipsum dolor sit.&lt;/p&gt;
