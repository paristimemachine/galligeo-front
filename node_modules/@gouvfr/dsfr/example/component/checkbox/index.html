...
<head>
    ...
    <title>Case à cocher - Design System</title>
...
<body id="top" class="fr-mb-12w">
  ...
  const e="system",t="dark",a="dark",c=()=>{document.documentElement.setAttribute("data-fr-theme",a),document.documentElement.style.colorScheme="dark"},o=()=>{window.matchMedia("(prefers-color-scheme: dark)").matches&&c()};(()=>{if(document.documentElement.matches(":root[data-fr-theme], :root[data-fr-scheme]")){const a=(()=>{try{return"localStorage"in window&&null!==window.localStorage}catch(e){return!1}})()?localStorage.getItem("scheme"):"",r=document.documentElement.getAttribute("data-fr-scheme");switch(!0){case a===t:c();break;case a===e:o();break;case r===t:c();break;case r===e:o()}}})();
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/case-a-cocher" target="_blank">Documentation</a>
    </div>
    <div class="fr-mb-12w">
                ...
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-checkbox-group">
                            ...
                            <div class="fr-messages-group" id="checkbox-messages" aria-live="assertive">
                            </div>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-867">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-867">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-checkbox-group">
                            ...
                            <div class="fr-messages-group" id="checkbox-sup-sub-messages" aria-live="assertive">
                            </div>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-868">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-868">
                                <pre class=" language-html"><code>&lt;div class="fr-checkbox-group"&gt;
    &lt;input id="checkbox-sup-sub" type="checkbox" aria-describedby="checkbox-sup-sub-messages"&gt;
    &lt;label class="fr-label" for="checkbox-sup-sub"&gt;
        &lt;span&gt;Label checkbox &lt;sub&gt;sub&lt;/sub&gt; et &lt;sup&gt;sup&lt;/sup&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-checkbox-group">
                            ...
                            <div class="fr-messages-group" id="checkbox-hint-messages" aria-live="assertive">
                            </div>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-869">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-869">
                                <pre class=" language-html"><code>&lt;div class="fr-checkbox-group"&gt;
    &lt;input id="checkbox-hint" type="checkbox" aria-describedby="checkbox-hint-messages"&gt;
    &lt;label class="fr-label" for="checkbox-hint"&gt;
        Label checkbox
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-870">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-870">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-871">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-871">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-872">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-872">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-873">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-873">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-874">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-874">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-875">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-875">
                        ...
                        <fieldset class="fr-fieldset" id="checkboxes-hint" aria-labelledby="checkboxes-hint-legend checkboxes-hint-messages">
                            ...
                            <div class="fr-fieldset__element">
                                <div class="fr-checkbox-group">
                                    ...
                                    <div class="fr-messages-group" id="checkboxes-hint-1-messages" aria-live="assertive">
                                    </div>
                                </div>
                            </div>
                            <div class="fr-fieldset__element">
                                <div class="fr-checkbox-group">
                                    ...
                                    <div class="fr-messages-group" id="checkboxes-hint-2-messages" aria-live="assertive">
                                    </div>
                                </div>
                            </div>
                            <div class="fr-fieldset__element">
                                <div class="fr-checkbox-group">
                                    ...
                                    <div class="fr-messages-group" id="checkboxes-hint-3-messages" aria-live="assertive">
                                    </div>
                                </div>
                            </div>
                            <div class="fr-messages-group" id="checkboxes-hint-messages" aria-live="assertive">
                            </div>
                        </fieldset>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-876">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-876">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-877">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-877">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-878">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-878">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-879">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-879">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-880">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-880">
                        ...
                        <fieldset class="fr-fieldset" id="checkboxes-hint-element" aria-labelledby="checkboxes-hint-element-legend checkboxes-hint-element-messages">
                            ...
                            <div class="fr-fieldset__element">
                                <div class="fr-checkbox-group">
                                    ...
                                    <div class="fr-messages-group" id="checkboxes-hint-element-1-messages" aria-live="assertive">
                                    </div>
                                </div>
                            </div>
                            <div class="fr-fieldset__element">
                                <div class="fr-checkbox-group">
                                    ...
                                    <div class="fr-messages-group" id="checkboxes-hint-element-2-messages" aria-live="assertive">
                                    </div>
                                </div>
                            </div>
                            <div class="fr-fieldset__element">
                                <div class="fr-checkbox-group">
                                    ...
                                    <div class="fr-messages-group" id="checkboxes-hint-element-3-messages" aria-live="assertive">
                                    </div>
                                </div>
                            </div>
                            <div class="fr-messages-group" id="checkboxes-hint-element-messages" aria-live="assertive">
                            </div>
                        </fieldset>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-881">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-881">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-882">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-882">
