                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-883">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-883">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-884">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-884">
                                <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkboxes-small-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-885">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-885">
                                <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkboxes-disabled-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-886">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-886">
                                <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--inline"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkboxes-inline-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-887">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-887">
                                <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkboxes-hint-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-888">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-888">
                                <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--error" aria-labelledby="checkboxes-error-legend checkboxes-error-desc-error" role="group"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkboxes-error-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-889">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-889">
                                <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--valid" aria-labelledby="checkboxes-valid-legend checkboxes-valid-desc-valid" role="group"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkboxes-valid-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-890">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-890">
                                <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--inline fr-fieldset--error" aria-labelledby="checkboxes-error-inline-legend checkboxes-error-inline-desc-error" role="group"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkboxes-error-inline-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-891">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-891">
                                <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--inline fr-fieldset--valid" aria-labelledby="checkboxes-valid-inline-legend checkboxes-valid-inline-desc-valid" role="group"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkboxes-valid-inline-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-892">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-892">
                                <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkboxes-hint-element-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-893">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-893">
                                <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkboxes-hint-el-sm-legend'&gt;
            Légende pour l’ensemble de champs
