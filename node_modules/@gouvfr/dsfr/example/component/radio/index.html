...
<head>
    ...
    <title>Bouton radio - Design System</title>
...
<body id="top" class="fr-mb-12w">
  ...
  const e="system",t="dark",a="dark",c=()=>{document.documentElement.setAttribute("data-fr-theme",a),document.documentElement.style.colorScheme="dark"},o=()=>{window.matchMedia("(prefers-color-scheme: dark)").matches&&c()};(()=>{if(document.documentElement.matches(":root[data-fr-theme], :root[data-fr-scheme]")){const a=(()=>{try{return"localStorage"in window&&null!==window.localStorage}catch(e){return!1}})()?localStorage.getItem("scheme"):"",r=document.documentElement.getAttribute("data-fr-scheme");switch(!0){case a===t:c();break;case a===e:o();break;case r===t:c();break;case r===e:o()}}})();
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <ul>
            <li>
                <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/boutons-radio" target="_blank">Bouton radio</a>
            </li>
            <li>
                <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/boutons-radio-riches" target="_blank">Bouton radio riche</a>
            </li>
        </ul>
    </div>
    <div class="fr-mb-12w">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-599">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-599">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-600">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-600">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-601">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-601">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-602">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-602">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-603">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-603">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-604">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-604">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-605">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-605">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-606">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-606">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-607">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-607">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-608">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-608">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-609">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-609">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-610">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-610">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-611">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-611">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-612">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-612">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-613">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-613">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-614">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-614">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-615">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-615">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-616">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-616">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-617">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-617">
