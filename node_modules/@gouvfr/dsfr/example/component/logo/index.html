...
<head>
    ...
    <title>Bloc marque - Design System</title>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-498">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-498">
...
&lt;/p&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-499">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-499">
...
&lt;/p&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-500">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-500">
...
&lt;/p&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-501">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-501">
                                <pre class=" language-html"><code>&lt;p class="fr-logo"&gt;
    Ministère
    &lt;br&gt;de la transition
    &lt;br&gt;écologique
...
&lt;/p&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-502">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-502">
                                <pre class=" language-html"><code>&lt;p class="fr-logo"&gt;
    Secrétaire d’État
    &lt;br&gt;chargé(e) de
    &lt;br&gt;l’égalité entre les
...
&lt;/p&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-503">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-503">
                                <pre class=" language-html"><code>&lt;p class="fr-logo"&gt;
    Ministère
    &lt;br&gt;de l’europe
    &lt;br&gt;et des affaires
