...
<head>
    ...
    <title>Tuile - Design System</title>
...
<body id="top" class="fr-mb-12w">
  ...
  const e="system",t="dark",a="dark",c=()=>{document.documentElement.setAttribute("data-fr-theme",a),document.documentElement.style.colorScheme="dark"},o=()=>{window.matchMedia("(prefers-color-scheme: dark)").matches&&c()};(()=>{if(document.documentElement.matches(":root[data-fr-theme], :root[data-fr-scheme]")){const a=(()=>{try{return"localStorage"in window&&null!==window.localStorage}catch(e){return!1}})()?localStorage.getItem("scheme"):"",r=document.documentElement.getAttribute("data-fr-scheme");switch(!0){case a===t:c();break;case a===e:o();break;case r===t:c();break;case r===e:o()}}})();
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Tuile (tile)</h1>
        <p>La tuile est un raccourci ou point d’entrée qui redirige les utilisateurs vers des pages de contenu. Elle fait généralement partie d'une collection ou liste de tuiles similaires. La tuile n’est jamais présentée de manière isolée.</p>
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/tuile" target="_blank">Documentation</a>
    </div>
    <div class="fr-mb-12w">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4574">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4574">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4575">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4575">
                                <pre class=" language-html"><code>&lt;div class="fr-grid-row fr-grid-row--gutters"&gt;
    &lt;div class="fr-col-6 fr-col-md-4 fr-col-lg-3"&gt;
        &lt;div class="fr-tile fr-enlarge-link"&gt;
            &lt;div class="fr-tile__body"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4576">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4576">
                                <pre class=" language-html"><code>&lt;div class="fr-grid-row fr-grid-row--gutters"&gt;
    &lt;div class="fr-col-6 fr-col-md-4 fr-col-lg-3"&gt;
        &lt;div class="fr-tile fr-enlarge-link"&gt;
            &lt;div class="fr-tile__body"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4577">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4577">
                                <pre class=" language-html"><code>&lt;div class="fr-grid-row fr-grid-row--gutters"&gt;
    &lt;div class="fr-col-6 fr-col-md-4 fr-col-lg-3"&gt;
        &lt;div class="fr-tile fr-enlarge-link"&gt;
            &lt;div class="fr-tile__body"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4578">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4578">
                                <pre class=" language-html"><code>&lt;div class="fr-grid-row fr-grid-row--gutters"&gt;
    &lt;div class="fr-col-6 fr-col-md-4 fr-col-lg-3"&gt;
        &lt;div class="fr-tile fr-enlarge-link fr-tile--grey"&gt;
            &lt;div class="fr-tile__body"&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Tuiles verticales, horizontales au dessus du breakpoint md</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-grid-row fr-grid-row--gutters">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4579">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4579">
                                <pre class=" language-html"><code>&lt;div class="fr-grid-row fr-grid-row--gutters"&gt;
    &lt;div class="fr-col-12  fr-col-md-4 fr-col-lg-3"&gt;
        &lt;div class="fr-tile fr-enlarge-link fr-tile--horizontal fr-tile--vertical-md"&gt;
            &lt;div class="fr-tile__body"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4580">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4580">
                                <pre class=" language-html"><code>&lt;div class="fr-grid-row fr-grid-row--gutters"&gt;
    &lt;div class="fr-col-12  fr-col-md-4 fr-col-lg-3"&gt;
        &lt;div class="fr-tile fr-enlarge-link fr-tile--horizontal fr-tile--vertical-md"&gt;
            &lt;div class="fr-tile__body"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4581">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4581">
                                <pre class=" language-html"><code>&lt;div class="fr-grid-row fr-grid-row--gutters"&gt;
    &lt;div class="fr-col-12  fr-col-md-4 fr-col-lg-3"&gt;
        &lt;div class="fr-tile fr-enlarge-link fr-tile--horizontal fr-tile--vertical-md"&gt;
            &lt;div class="fr-tile__body"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4582">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4582">
                                <pre class=" language-html"><code>&lt;div class="fr-grid-row fr-grid-row--gutters"&gt;
    &lt;div class="fr-col-12  fr-col-md-4 fr-col-lg-3"&gt;
        &lt;div class="fr-tile fr-enlarge-link fr-tile--horizontal fr-tile--vertical-md"&gt;
            &lt;div class="fr-tile__body"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4583">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4583">
                                <pre class=" language-html"><code>&lt;div class="fr-grid-row fr-grid-row--gutters"&gt;
    &lt;div class="fr-col-12"&gt;
        &lt;div class="fr-tile fr-enlarge-link fr-tile--horizontal"&gt;
            &lt;div class="fr-tile__body"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4584">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4584">
                                <pre class=" language-html"><code>&lt;div class="fr-grid-row fr-grid-row--gutters"&gt;
    &lt;div class="fr-col-12"&gt;
        &lt;div class="fr-tile fr-enlarge-link fr-tile--horizontal"&gt;
            &lt;div class="fr-tile__body"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4585">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4585">
                                <pre class=" language-html"><code>&lt;div class="fr-grid-row fr-grid-row--gutters"&gt;
    &lt;div class="fr-col-12"&gt;
        &lt;div class="fr-tile fr-enlarge-link fr-tile--horizontal"&gt;
            &lt;div class="fr-tile__body"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4586">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4586">
                                <pre class=" language-html"><code>&lt;div class="fr-grid-row fr-grid-row--gutters"&gt;
    &lt;div class="fr-col-12"&gt;
        &lt;div class="fr-tile fr-enlarge-link fr-tile--horizontal"&gt;
            &lt;div class="fr-tile__body"&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Tuiles horizontales, verticales au dessus du breakpoint md</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-grid-row fr-grid-row--gutters">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4587">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4587">
                                <pre class=" language-html"><code>&lt;div class="fr-grid-row fr-grid-row--gutters"&gt;
    &lt;div class="fr-col-6 fr-col-md-12"&gt;
        &lt;div class="fr-tile fr-enlarge-link fr-tile--horizontal-md"&gt;
            &lt;div class="fr-tile__body"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4588">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4588">
                                <pre class=" language-html"><code>&lt;div class="fr-grid-row fr-grid-row--gutters"&gt;
    &lt;div class="fr-col-6 fr-col-md-12"&gt;
        &lt;div class="fr-tile fr-enlarge-link fr-tile--horizontal-md"&gt;
            &lt;div class="fr-tile__body"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4589">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4589">
                                <pre class=" language-html"><code>&lt;div class="fr-grid-row fr-grid-row--gutters"&gt;
    &lt;div class="fr-col-6 fr-col-md-12"&gt;
        &lt;div class="fr-tile fr-enlarge-link fr-tile--horizontal-md"&gt;
            &lt;div class="fr-tile__body"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4590">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4590">
                                <pre class=" language-html"><code>&lt;div class="fr-grid-row fr-grid-row--gutters"&gt;
    &lt;div class="fr-col-6 fr-col-md-12"&gt;
        &lt;div class="fr-tile fr-enlarge-link fr-tile--horizontal-md"&gt;
            &lt;div class="fr-tile__body"&gt;
