...
<head>
    ...
    <title>Mise en avant - Design System</title>
...
<body id="top" class="fr-mb-12w">
  ...
  const e="system",t="dark",a="dark",c=()=>{document.documentElement.setAttribute("data-fr-theme",a),document.documentElement.style.colorScheme="dark"},o=()=>{window.matchMedia("(prefers-color-scheme: dark)").matches&&c()};(()=>{if(document.documentElement.matches(":root[data-fr-theme], :root[data-fr-scheme]")){const a=(()=>{try{return"localStorage"in window&&null!==window.localStorage}catch(e){return!1}})()?localStorage.getItem("scheme"):"",r=document.documentElement.getAttribute("data-fr-scheme");switch(!0){case a===t:c();break;case a===e:o();break;case r===t:c();break;case r===e:o()}}})();
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/mise-en-avant" target="_blank">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <div id="callout-3779" class="fr-callout">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3781">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-3781">
                                <pre class=" language-html"><code>&lt;div id="callout-3780" class="fr-callout"&gt;
    &lt;p class="fr-callout__text"&gt;Les parents d’enfants de 11 à 14 ans n’ont aucune démarche à accomplir : les CAF versent automatiquement l’ARS aux familles déjà allocataires qui remplissent les conditions.&lt;/p&gt;
&lt;/div&gt;
</code></pre>
                            </div>
                    ...
                    <div class="fr-mb-6v">
                        <div id="callout-3782" class="fr-callout">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3784">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-3784">
                                <pre class=" language-html"><code>&lt;div id="callout-3783" class="fr-callout"&gt;
    &lt;h3 class="fr-callout__title"&gt;Titre mise en avant&lt;/h3&gt;
    &lt;p class="fr-callout__text"&gt;Les parents d’enfants de 11 à 14 ans n’ont aucune démarche à accomplir : les CAF versent automatiquement l’ARS aux familles déjà allocataires qui remplissent les conditions.&lt;/p&gt;
&lt;/div&gt;
</code></pre>
                    ...
                    <div class="fr-mb-6v">
                        <div id="callout-3785" class="fr-callout">
                            <h3 class="fr-callout__title">Titre mise en avant</h3>
                            <p class="fr-callout__text">Les parents d’enfants de 11 à 14 ans n’ont aucune démarche à accomplir : les CAF versent automatiquement l’ARS aux familles déjà allocataires qui remplissent les conditions.</p>
                            <button class="fr-btn">
                                Label bouton
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3787">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-3787">
                                <pre class=" language-html"><code>&lt;div id="callout-3786" class="fr-callout"&gt;
    &lt;h3 class="fr-callout__title"&gt;Titre mise en avant&lt;/h3&gt;
    &lt;p class="fr-callout__text"&gt;Les parents d’enfants de 11 à 14 ans n’ont aucune démarche à accomplir : les CAF versent automatiquement l’ARS aux familles déjà allocataires qui remplissent les conditions.&lt;/p&gt;
    &lt;button class="fr-btn"&gt;
        Label bouton
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div id="callout-3788" class="fr-callout fr-icon-info-line">
                            <h3 class="fr-callout__title">Titre mise en avant</h3>
                            <p class="fr-callout__text">Les parents d’enfants de 11 à 14 ans n’ont aucune démarche à accomplir : les CAF versent automatiquement l’ARS aux familles déjà allocataires qui remplissent les conditions.</p>
                            <button class="fr-btn">
                                Label bouton
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3790">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-3790">
                                <pre class=" language-html"><code>&lt;div id="callout-3789" class="fr-callout fr-icon-info-line"&gt;
    &lt;h3 class="fr-callout__title"&gt;Titre mise en avant&lt;/h3&gt;
    &lt;p class="fr-callout__text"&gt;Les parents d’enfants de 11 à 14 ans n’ont aucune démarche à accomplir : les CAF versent automatiquement l’ARS aux familles déjà allocataires qui remplissent les conditions.&lt;/p&gt;
    &lt;button class="fr-btn"&gt;
        Label bouton
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div id="callout-3791" class="fr-callout fr-callout--green-emeraude">
                            <h3 class="fr-callout__title">Titre mise en avant</h3>
                            <p class="fr-callout__text">Les parents d’enfants de 11 à 14 ans n’ont aucune démarche à accomplir : les CAF versent automatiquement l’ARS aux familles déjà allocataires qui remplissent les conditions.</p>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3793">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-3793">
                                <pre class=" language-html"><code>&lt;div id="callout-3792" class="fr-callout fr-callout--green-emeraude"&gt;
    &lt;h3 class="fr-callout__title"&gt;Titre mise en avant&lt;/h3&gt;
    &lt;p class="fr-callout__text"&gt;Les parents d’enfants de 11 à 14 ans n’ont aucune démarche à accomplir : les CAF versent automatiquement l’ARS aux familles déjà allocataires qui remplissent les conditions.&lt;/p&gt;
&lt;/div&gt;
</code></pre>
