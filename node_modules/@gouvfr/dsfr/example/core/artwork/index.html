  ...
  const e="system",t="dark",a="dark",c=()=>{document.documentElement.setAttribute("data-fr-theme",a),document.documentElement.style.colorScheme="dark"},o=()=>{window.matchMedia("(prefers-color-scheme: dark)").matches&&c()};(()=>{if(document.documentElement.matches(":root[data-fr-theme], :root[data-fr-scheme]")){const a=(()=>{try{return"localStorage"in window&&null!==window.localStorage}catch(e){return!1}})()?localStorage.getItem("scheme"):"",r=document.documentElement.getAttribute("data-fr-scheme");switch(!0){case a===t:c();break;case a===e:o();break;case r===t:c();break;case r===e:o()}}})();
    ...
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-mt-0">
                <h2>Pictogramme - artwork</h2>
                <p>Les pictogrammes svg, ou "artwork", sont disponibles dans le dossier <b>dist/artwork/pictograms</b>.
                    <br> Contrairement aux icônes, les pictogrammes sont composés de 3 couleurs : "decorative", "minor", "major".
                    <br>La couleur mineure peut être modifiée par un modificateur d'accentuation (ex: fr-artwork--green-emeraude)
                </p>
            </div>
            <h3>Ajout d&#39;un pictogramme</h3>
            <div class="fr-mb-6v">
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-1">
...
&lt;/svg&gt;
            ...
            <h3>Pictogramme accentué en green-emeraude</h3>
            <div class="fr-mb-6v">
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-2">
                        <pre class=" language-html"><code>&lt;svg aria-hidden="true" class="fr-artwork fr-artwork--green-emeraude" viewBox="0 0 80 80" width="80px" height="80px"&gt;
    &lt;use class="fr-artwork-decorative" href="../../../dist/artwork/pictograms/environment/moon.svg#artwork-decorative"&gt;&lt;/use&gt;
    &lt;use class="fr-artwork-minor" href="../../../dist/artwork/pictograms/environment/moon.svg#artwork-minor"&gt;&lt;/use&gt;
    &lt;use class="fr-artwork-major" href="../../../dist/artwork/pictograms/environment/moon.svg#artwork-major"&gt;&lt;/use&gt;
&lt;/svg&gt;
            ...
            <div class="fr-mt-0">
                <h2>Formatage du SVG</h2>
                <p>Pour fonctionner en accord avec les couleurs du design system, les fichiers SVG doivent être formatés de cette façon :</p>
            </div>
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-3">
                        <pre class=" language-html"><code>&lt;svg width="80px" height="80px" viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"&gt;
    &lt;style&gt;
...
&lt;/svg&gt;
            ...
            <div class="fr-mt-32v">
                <h2>Liste des pictogrammes disponibles dans les utilitaires.</h2>
            </div>
        </div>
    </div>
