...
<head>
    ...
    <title>Système de design de l&#39;État - Design System</title>
    ...
    <link href="../dist/dsfr.main.css" rel="stylesheet" file="main">
    <link href="../dist/utility/utility.legacy.css" rel="stylesheet" file="legacy">
    <link href="../dist/dsfr.legacy.css" rel="stylesheet" file="legacy">
    <style>
        code[class*="language-"],
        pre[class*="language-"] {
...
<body id="top" class="fr-mb-12w">
  ...
  const e="system",t="dark",a="dark",c=()=>{document.documentElement.setAttribute("data-fr-theme",a),document.documentElement.style.colorScheme="dark"},o=()=>{window.matchMedia("(prefers-color-scheme: dark)").matches&&c()};(()=>{if(document.documentElement.matches(":root[data-fr-theme], :root[data-fr-scheme]")){const a=(()=>{try{return"localStorage"in window&&null!==window.localStorage}catch(e){return!1}})()?localStorage.getItem("scheme"):"",r=document.documentElement.getAttribute("data-fr-scheme");switch(!0){case a===t:c();break;case a===e:o();break;case r===t:c();break;case r===e:o()}}})();
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Système de design de l&#39;État (dsfr)</h1>
    </div>
    <div class="fr-container">
        <ul class="fr-col-12">
            <li class="fr-mb-1w">
                <a href='./core/'>Fondamentaux (core)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./scheme/'>Combinaison de couleur (scheme)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./analytics/'>Outils d&#39;analyse (analytics)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./component/'>Composant (component)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./pattern/'>Modèle (pattern)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./page/'>Modèle de page (page)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./utility/'>Utilitaire (utility)</a>
            </li>
        </ul>
    </div>
    ...
    <script type="module" src="../dist/dsfr.module.js"></script>
    <script type="text/javascript" nomodule src="../dist/dsfr.nomodule.js"></script>
