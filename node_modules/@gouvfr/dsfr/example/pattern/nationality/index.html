...
<head>
    ...
    <title>Modèle de bloc de nationalité - Design System</title>
...
<body id="top" class="fr-mb-12w">
  ...
  const e="system",t="dark",a="dark",c=()=>{document.documentElement.setAttribute("data-fr-theme",a),document.documentElement.style.colorScheme="dark"},o=()=>{window.matchMedia("(prefers-color-scheme: dark)").matches&&c()};(()=>{if(document.documentElement.matches(":root[data-fr-theme], :root[data-fr-scheme]")){const a=(()=>{try{return"localStorage"in window&&null!==window.localStorage}catch(e){return!1}})()?localStorage.getItem("scheme"):"",r=document.documentElement.getAttribute("data-fr-scheme");switch(!0){case a===t:c();break;case a===e:o();break;case r===t:c();break;case r===e:o()}}})();
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Modèle de bloc de nationalité (nationality)</h1>
        <p>La demande de nationalité permet d’aider un utilisateur à saisir sa nationalité.</p>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-grid-row fr-mb-6v">
                <div class="fr-col-12">
                    <h4>Demande de nationalité</h4>
                </div>
            </div>
            <div class="fr-grid-row fr-grid-row--gutters fr-grid-row--center fr-mb-6v">
                <div class="fr-col-md-8 fr-col-xl-6 fr-col-12">
                    <fieldset class="fr-fieldset" id="nationality-4664" aria-labelledby="nationality-4664-legend nationality-4664-messages">
                        <legend class="fr-sr-only" id="nationality-4664-legend">
                            Nationalité
                        </legend>
                        <div class="fr-fieldset__element">
                            <div class="fr-select-group">
                                <label class="fr-label" for="nationality-select-4663">
                                    Nationalité
                                </label>
                                <select class="fr-select" aria-describedby="nationality-select-4663-messages" id="nationality-select-4663" name="country">
                                ...
                                <div class="fr-messages-group" id="nationality-select-4663-messages" aria-live="assertive">
                                </div>
                            </div>
                        </div>
                        <div class="fr-messages-group" id="nationality-4664-messages" aria-live="assertive">
                        </div>
                    </fieldset>
                </div>
            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4667">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4667">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="nationality-4666" aria-labelledby="nationality-4666-legend nationality-4666-messages"&gt;
    &lt;legend class="fr-sr-only" id="nationality-4666-legend"&gt;
        Nationalité
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-select-group"&gt;
            &lt;label class="fr-label" for="nationality-select-4665"&gt;
                Nationalité
            &lt;/label&gt;
            &lt;select class="fr-select" aria-describedby="nationality-select-4665-messages" id="nationality-select-4665" name="country"&gt;
                &lt;option value="" selected disabled hidden&gt;Sélectionner une option&lt;/option&gt;
                &lt;option value="FR"&gt;Française&lt;/option&gt;
                &lt;option value="DE"&gt;Allemande&lt;/option&gt;
                &lt;option value="IT"&gt;Italienne&lt;/option&gt;
                &lt;option value="ES"&gt;Espagnole&lt;/option&gt;
            &lt;/select&gt;
            &lt;div class="fr-messages-group" id="nationality-select-4665-messages" aria-live="assertive"&gt;
            &lt;/div&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    &lt;div class="fr-messages-group" id="nationality-4666-messages" aria-live="assertive"&gt;
    &lt;/div&gt;
&lt;/fieldset&gt;
</code></pre>
                            </div>
