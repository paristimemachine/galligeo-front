...
<head>
    ...
    <title>Modèle de bloc de civilité - Design System</title>
...
<body id="top" class="fr-mb-12w">
  ...
  const e="system",t="dark",a="dark",c=()=>{document.documentElement.setAttribute("data-fr-theme",a),document.documentElement.style.colorScheme="dark"},o=()=>{window.matchMedia("(prefers-color-scheme: dark)").matches&&c()};(()=>{if(document.documentElement.matches(":root[data-fr-theme], :root[data-fr-scheme]")){const a=(()=>{try{return"localStorage"in window&&null!==window.localStorage}catch(e){return!1}})()?localStorage.getItem("scheme"):"",r=document.documentElement.getAttribute("data-fr-scheme");switch(!0){case a===t:c();break;case a===e:o();break;case r===t:c();break;case r===e:o()}}})();
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Modèle de bloc de civilité (civility)</h1>
        <p>La demande de civilité permet à un utilisateur de donner sa civilité (sexe, situation familière, titre d’appel).</p>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-grid-row fr-mb-6v">
                <div class="fr-col-12">
                    <h4>Demande du sexe</h4>
                </div>
            </div>
            <div class="fr-grid-row fr-grid-row--gutters fr-grid-row--center fr-mb-6v">
                <div class="fr-col-md-8 fr-col-xl-6 fr-col-12">
                    <fieldset class="fr-fieldset" id="sex-4637" aria-labelledby="sex-4637-legend sex-4637-messages">
                        <legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="sex-4637-legend">
                            Sexe
                        </legend>
                        <div class="fr-fieldset__element">
                            <div class="fr-radio-group fr-radio-group--sm">
                                <input type="radio" id="female-4638" name="sex">
                                <label class="fr-label" for="female-4638">
                                    Feminin
                                </label>
                            </div>
                        </div>
                        <div class="fr-fieldset__element">
                            <div class="fr-radio-group fr-radio-group--sm">
                                <input type="radio" id="male-4639" name="sex">
                                <label class="fr-label" for="male-4639">
                                    Masculin
                                </label>
                            </div>
                        </div>
                        <div class="fr-messages-group" id="sex-4637-messages" aria-live="assertive">
                        </div>
                    </fieldset>
                </div>
            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4643">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4643">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="sex-4640" aria-labelledby="sex-4640-legend sex-4640-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="sex-4640-legend"&gt;
        Sexe
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-radio-group fr-radio-group--sm"&gt;
            &lt;input type="radio" id="female-4641" name="sex"&gt;
            &lt;label class="fr-label" for="female-4641"&gt;
                Feminin
            &lt;/label&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-radio-group fr-radio-group--sm"&gt;
            &lt;input type="radio" id="male-4642" name="sex"&gt;
            &lt;label class="fr-label" for="male-4642"&gt;
                Masculin
            &lt;/label&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    &lt;div class="fr-messages-group" id="sex-4640-messages" aria-live="assertive"&gt;
    &lt;/div&gt;
&lt;/fieldset&gt;
</code></pre>
                            </div>
            ...
            <div class="fr-grid-row fr-mb-6v">
                <div class="fr-col-12">
                    <h4>Demande de situation familiale</h4>
                </div>
            </div>
            <div class="fr-grid-row fr-grid-row--gutters fr-grid-row--center fr-mb-6v">
                <div class="fr-col-md-8 fr-col-xl-6 fr-col-12">
                    <fieldset class="fr-fieldset" id="family-4644" aria-labelledby="family-4644-legend family-4644-messages">
                        <legend class="fr-sr-only" id="family-4644-legend">
                            Demande de situation familiale
                        </legend>
                        <div class="fr-fieldset__element">
                            <div class="fr-select-group">
                                <label class="fr-label" for="family-4645">
                                    Situation familiale
                                </label>
                                <select class="fr-select" aria-describedby="family-4645-messages" id="family-4645" name="family">
                                ...
                                <div class="fr-messages-group" id="family-4645-messages" aria-live="assertive">
                                </div>
                            </div>
                        </div>
                        <div class="fr-messages-group" id="family-4644-messages" aria-live="assertive">
                        </div>
                    </fieldset>
                </div>
            </div>
            <div class="fr-grid-row fr-mb-6v">
                <div class="fr-col-12">
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4648">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4648">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="family-4646" aria-labelledby="family-4646-legend family-4646-messages"&gt;
    &lt;legend class="fr-sr-only" id="family-4646-legend"&gt;
        Demande de situation familiale
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-select-group"&gt;
            &lt;label class="fr-label" for="family-4647"&gt;
                Situation familiale
            &lt;/label&gt;
            &lt;select class="fr-select" aria-describedby="family-4647-messages" id="family-4647" name="family"&gt;
                &lt;option value="" selected disabled hidden&gt;Sélectionner une option&lt;/option&gt;
                &lt;option value="1"&gt;Célibataire&lt;/option&gt;
                &lt;option value="2"&gt;Concubinage&lt;/option&gt;
                &lt;option value="3"&gt;Pacsé&lt;/option&gt;
                ...
                &lt;option value="7"&gt;Sans réponse&lt;/option&gt;
            &lt;/select&gt;
            &lt;div class="fr-messages-group" id="family-4647-messages" aria-live="assertive"&gt;
            &lt;/div&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    &lt;div class="fr-messages-group" id="family-4646-messages" aria-live="assertive"&gt;
    &lt;/div&gt;
&lt;/fieldset&gt;
</code></pre>
                            </div>
            ...
            <div class="fr-mt-0">
                <p>Les boutons radios sont recommandés lorsque l’utilisateur doit choisir un élément parmi 2 à 5 choix possibles.</p>
            </div>
            <div class="fr-grid-row fr-mb-6v">
                <div class="fr-col-12">
                    <h4>Demande du titre d’appel</h4>
                </div>
            </div>
            <div class="fr-grid-row fr-grid-row--gutters fr-grid-row--center fr-mb-6v">
                <div class="fr-col-md-8 fr-col-xl-6 fr-col-12">
                    <fieldset class="fr-fieldset" id="honorific-4649" aria-labelledby="honorific-4649-legend honorific-4649-messages">
                        <legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="honorific-4649-legend">
                            Titre d’appel
                        </legend>
                        <div class="fr-fieldset__element">
                            <div class="fr-radio-group">
                                <input type="radio" id="honorific-4650" name="honorific">
                                <label class="fr-label" for="honorific-4650">
                                    Docteur
                                </label>
                            </div>
                        </div>
                        <div class="fr-fieldset__element">
                            <div class="fr-radio-group">
                                <input type="radio" id="honorific-4651" name="honorific">
                                <label class="fr-label" for="honorific-4651">
                                    Inspecteur
                                </label>
                            </div>
                        </div>
                        <div class="fr-fieldset__element">
                            <div class="fr-radio-group">
                                <input type="radio" id="honorific-4652" name="honorific">
                                <label class="fr-label" for="honorific-4652">
                                    Sans réponse
                                </label>
                            </div>
                        </div>
                        <div class="fr-messages-group" id="honorific-4649-messages" aria-live="assertive">
                        </div>
                    </fieldset>
                </div>
            </div>
            <div class="fr-grid-row fr-mb-6v">
                <div class="fr-col-12">
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4657">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4657">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="honorific-4653" aria-labelledby="honorific-4653-legend honorific-4653-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="honorific-4653-legend"&gt;
        Titre d’appel
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-radio-group"&gt;
            &lt;input type="radio" id="honorific-4654" name="honorific"&gt;
            &lt;label class="fr-label" for="honorific-4654"&gt;
                Docteur
            &lt;/label&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-radio-group"&gt;
            &lt;input type="radio" id="honorific-4655" name="honorific"&gt;
            &lt;label class="fr-label" for="honorific-4655"&gt;
                Inspecteur
            &lt;/label&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-radio-group"&gt;
            &lt;input type="radio" id="honorific-4656" name="honorific"&gt;
            &lt;label class="fr-label" for="honorific-4656"&gt;
                Sans réponse
            &lt;/label&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    &lt;div class="fr-messages-group" id="honorific-4653-messages" aria-live="assertive"&gt;
    &lt;/div&gt;
&lt;/fieldset&gt;
</code></pre>
                            </div>
            ...
            <div class="fr-mt-0">
                <p>Au delà de 5 choix ou lorsque l’espace n’est pas suffisant, il est préférable d’utiliser une liste déroulante.</p>
            </div>
            <div class="fr-grid-row fr-mb-6v">
                <div class="fr-col-12">
                    <h4>Demande du titre d’appel</h4>
            ...
            <div class="fr-grid-row fr-grid-row--gutters fr-grid-row--center fr-mb-6v">
                <div class="fr-col-md-8 fr-col-xl-6 fr-col-12">
                    <fieldset class="fr-fieldset" id="honorific-4658" aria-labelledby="honorific-4658-legend honorific-4658-messages">
                        <legend class="fr-sr-only" id="honorific-4658-legend">
                            Demande du titre d’appel
                        </legend>
                        <div class="fr-fieldset__element">
                            <div class="fr-select-group">
                                <label class="fr-label" for="honorific-4659">
                                    Titre d’appel
                                </label>
                                <select class="fr-select" aria-describedby="honorific-4659-messages" id="honorific-4659" name="honorific">
                                    <option value="" selected disabled hidden>Sélectionner une option</option>
                                ...
                                <div class="fr-messages-group" id="honorific-4659-messages" aria-live="assertive">
                                </div>
                            </div>
                        </div>
                        <div class="fr-messages-group" id="honorific-4658-messages" aria-live="assertive">
                        </div>
                    </fieldset>
                </div>
            </div>
            <div class="fr-grid-row fr-mb-6v">
                <div class="fr-col-12">
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4662">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4662">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="honorific-4660" aria-labelledby="honorific-4660-legend honorific-4660-messages"&gt;
    &lt;legend class="fr-sr-only" id="honorific-4660-legend"&gt;
        Demande du titre d’appel
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-select-group"&gt;
            &lt;label class="fr-label" for="honorific-4661"&gt;
                Titre d’appel
            &lt;/label&gt;
            &lt;select class="fr-select" aria-describedby="honorific-4661-messages" id="honorific-4661" name="honorific"&gt;
                &lt;option value="" selected disabled hidden&gt;Sélectionner une option&lt;/option&gt;
                &lt;option value="1"&gt;Recteur&lt;/option&gt;
                &lt;option value="2"&gt;Inspecteur&lt;/option&gt;
                &lt;option value="3"&gt;Proviseur&lt;/option&gt;
                ...
                &lt;option value="7"&gt;Sans réponse&lt;/option&gt;
            &lt;/select&gt;
            &lt;div class="fr-messages-group" id="honorific-4661-messages" aria-live="assertive"&gt;
            &lt;/div&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    &lt;div class="fr-messages-group" id="honorific-4660-messages" aria-live="assertive"&gt;
    &lt;/div&gt;
&lt;/fieldset&gt;
</code></pre>
                            </div>
