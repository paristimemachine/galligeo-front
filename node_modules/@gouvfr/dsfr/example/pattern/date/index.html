...
<head>
    ...
    <title>Modèle de date unique - Design System</title>
...
<body id="top" class="fr-mb-12w">
  ...
  const e="system",t="dark",a="dark",c=()=>{document.documentElement.setAttribute("data-fr-theme",a),document.documentElement.style.colorScheme="dark"},o=()=>{window.matchMedia("(prefers-color-scheme: dark)").matches&&c()};(()=>{if(document.documentElement.matches(":root[data-fr-theme], :root[data-fr-scheme]")){const a=(()=>{try{return"localStorage"in window&&null!==window.localStorage}catch(e){return!1}})()?localStorage.getItem("scheme"):"",r=document.documentElement.getAttribute("data-fr-scheme");switch(!0){case a===t:c();break;case a===e:o();break;case r===t:c();break;case r===e:o()}}})();
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Modèle de date unique (date)</h1>
        <p>Le champ de saisie de date fixe reprend trois champs de saisie de texte.</p>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            ...
            <div class="fr-grid-row fr-grid-row--gutters fr-grid-row--center fr-mb-6v">
                <div class="fr-col-md-8 fr-col-xl-6 fr-col-12">
                    <fieldset class="fr-fieldset" id="date-4828" aria-labelledby="date-4828-legend date-4828-messages">
                        <legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="date-4828-legend">
                            Date de naissance
                            <span class="fr-hint-text">Texte de description additionnel</span>
                        </legend>
                        <div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--number">
                            <div class="fr-input-group">
                                <label class="fr-label" for="date-4828-bday-day">
                                    Jour
                                    <span class="fr-hint-text">Exemple : 14</span>
                                </label>
                                <input class="fr-input" name="day" autocomplete="bday-day" id="date-4828-bday-day" type="text">
                            </div>
                        </div>
                        <div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--number">
                            <div class="fr-input-group">
                                <label class="fr-label" for="date-4828-bday-month">
                                    Mois
                                    <span class="fr-hint-text">Exemple : 12</span>
                                </label>
                                <input class="fr-input" name="month" autocomplete="bday-month" id="date-4828-bday-month" type="text">
                            </div>
                        </div>
                        <div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--inline-grow fr-fieldset__element--year">
                            <div class="fr-input-group">
                                <label class="fr-label" for="date-4828-bday-year">
                                    Année
                                    <span class="fr-hint-text">Exemple : 1984</span>
                                </label>
                                <input class="fr-input" name="year" autocomplete="bday-year" id="date-4828-bday-year" type="text">
                            </div>
                        </div>
                        <div class="fr-messages-group" id="date-4828-messages" aria-live="assertive">
                        </div>
                    </fieldset>
                </div>
            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4830">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4830">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="date-4829" aria-labelledby="date-4829-legend date-4829-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="date-4829-legend"&gt;
        Date de naissance
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--number"&gt;
        &lt;div class="fr-input-group"&gt;
            &lt;label class="fr-label" for="date-4829-bday-day"&gt;
                Jour
                &lt;span class="fr-hint-text"&gt;Exemple : 14&lt;/span&gt;
            &lt;/label&gt;
            &lt;input class="fr-input" name="day" autocomplete="bday-day" id="date-4829-bday-day" type="text"&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    &lt;div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--number"&gt;
        &lt;div class="fr-input-group"&gt;
            &lt;label class="fr-label" for="date-4829-bday-month"&gt;
                Mois
                &lt;span class="fr-hint-text"&gt;Exemple : 12&lt;/span&gt;
            &lt;/label&gt;
            &lt;input class="fr-input" name="month" autocomplete="bday-month" id="date-4829-bday-month" type="text"&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    &lt;div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--inline-grow fr-fieldset__element--year"&gt;
        &lt;div class="fr-input-group"&gt;
            &lt;label class="fr-label" for="date-4829-bday-year"&gt;
                Année
                &lt;span class="fr-hint-text"&gt;Exemple : 1984&lt;/span&gt;
            &lt;/label&gt;
            &lt;input class="fr-input" name="year" autocomplete="bday-year" id="date-4829-bday-year" type="text"&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    &lt;div class="fr-messages-group" id="date-4829-messages" aria-live="assertive"&gt;
    &lt;/div&gt;
&lt;/fieldset&gt;
</code></pre>
                            </div>
            ...
            <div class="fr-grid-row fr-mb-6v">
                <div class="fr-col-12">
                    <h4>Erreur unitaire</h4>
                </div>
            </div>
            <div class="fr-grid-row fr-grid-row--gutters fr-grid-row--center fr-mb-6v">
                <div class="fr-col-md-8 fr-col-xl-6 fr-col-12">
                    <fieldset class="fr-fieldset fr-fieldset--error" id="date-error-4831" role="group" aria-labelledby="date-error-4831-legend date-error-4831-messages">
                        <legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="date-error-4831-legend">
                            Date de naissance
                            <span class="fr-hint-text">Texte de description additionnel</span>
                        </legend>
                        <div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--number">
                            <div class="fr-input-group">
                                <label class="fr-label" for="date-error-4831-bday-day">
                                    Jour
                                    <span class="fr-hint-text">Exemple : 14</span>
                                </label>
                                <input class="fr-input" name="day" autocomplete="bday-day" id="date-error-4831-bday-day" type="text">
                            </div>
                        </div>
                        <div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--number">
                            <div class="fr-input-group">
                                <label class="fr-label" for="date-error-4831-bday-month">
                                    Mois
                                    <span class="fr-hint-text">Exemple : 12</span>
                                </label>
                                <input class="fr-input" name="month" autocomplete="bday-month" id="date-error-4831-bday-month" type="text">
                            </div>
                        </div>
                        <div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--inline-grow fr-fieldset__element--year">
                            <div class="fr-input-group">
                                <label class="fr-label" for="date-error-4831-bday-year">
                                    Année
                                    <span class="fr-hint-text">Exemple : 1984</span>
                                </label>
                                <input class="fr-input" name="year" autocomplete="bday-year" id="date-error-4831-bday-year" type="text">
                            </div>
                        </div>
                        <div class="fr-messages-group" id="date-error-4831-messages" aria-live="assertive">
                            <p class="fr-message fr-message--error" id="date-error-4831-message-error-1">Le jour est invalide</p>
                            <p class="fr-message fr-message--error" id="date-error-4831-message-error-2">Le mois est invalide</p>
                            <p class="fr-message fr-message--error" id="date-error-4831-message-error-3">L’année est invalide</p>
                        </div>
                    </fieldset>
                </div>
            </div>
            <div class="fr-grid-row fr-mb-6v">
                <div class="fr-col-12">
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4833">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4833">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset fr-fieldset--error" id="date-error-4832" role="group" aria-labelledby="date-error-4832-legend date-error-4832-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="date-error-4832-legend"&gt;
        Date de naissance
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--number"&gt;
        &lt;div class="fr-input-group"&gt;
            &lt;label class="fr-label" for="date-error-4832-bday-day"&gt;
                Jour
                &lt;span class="fr-hint-text"&gt;Exemple : 14&lt;/span&gt;
            &lt;/label&gt;
            &lt;input class="fr-input" name="day" autocomplete="bday-day" id="date-error-4832-bday-day" type="text"&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    &lt;div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--number"&gt;
        &lt;div class="fr-input-group"&gt;
            &lt;label class="fr-label" for="date-error-4832-bday-month"&gt;
                Mois
                &lt;span class="fr-hint-text"&gt;Exemple : 12&lt;/span&gt;
            &lt;/label&gt;
            &lt;input class="fr-input" name="month" autocomplete="bday-month" id="date-error-4832-bday-month" type="text"&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    &lt;div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--inline-grow fr-fieldset__element--year"&gt;
        &lt;div class="fr-input-group"&gt;
            &lt;label class="fr-label" for="date-error-4832-bday-year"&gt;
                Année
                &lt;span class="fr-hint-text"&gt;Exemple : 1984&lt;/span&gt;
            &lt;/label&gt;
            &lt;input class="fr-input" name="year" autocomplete="bday-year" id="date-error-4832-bday-year" type="text"&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    &lt;div class="fr-messages-group" id="date-error-4832-messages" aria-live="assertive"&gt;
        &lt;p class="fr-message fr-message--error" id="date-error-4832-message-error-1"&gt;Le jour est invalide&lt;/p&gt;
        &lt;p class="fr-message fr-message--error" id="date-error-4832-message-error-2"&gt;Le mois est invalide&lt;/p&gt;
        &lt;p class="fr-message fr-message--error" id="date-error-4832-message-error-3"&gt;L’année est invalide&lt;/p&gt;
    &lt;/div&gt;
&lt;/fieldset&gt;
</code></pre>
                            </div>
            ...
            <div class="fr-grid-row fr-mb-6v">
                <div class="fr-col-12">
                    <h4>Erreur globale</h4>
                </div>
            </div>
            <div class="fr-grid-row fr-grid-row--gutters fr-grid-row--center fr-mb-6v">
                <div class="fr-col-md-8 fr-col-xl-6 fr-col-12">
                    <fieldset class="fr-fieldset fr-fieldset--error" id="date-error-4834" role="group" aria-labelledby="date-error-4834-legend date-error-4834-messages">
                        <legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="date-error-4834-legend">
                            Date de naissance
                            <span class="fr-hint-text">Texte de description additionnel</span>
                        </legend>
                        <div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--number">
                            <div class="fr-input-group">
                                <label class="fr-label" for="date-error-4834-bday-day">
                                    Jour
                                    <span class="fr-hint-text">Exemple : 14</span>
                                </label>
                                <input class="fr-input" name="day" autocomplete="bday-day" id="date-error-4834-bday-day" type="text">
                            </div>
                        </div>
                        <div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--number">
                            <div class="fr-input-group">
                                <label class="fr-label" for="date-error-4834-bday-month">
                                    Mois
                                    <span class="fr-hint-text">Exemple : 12</span>
                                </label>
                                <input class="fr-input" name="month" autocomplete="bday-month" id="date-error-4834-bday-month" type="text">
                            </div>
                        </div>
                        <div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--inline-grow fr-fieldset__element--year">
                            <div class="fr-input-group">
                                <label class="fr-label" for="date-error-4834-bday-year">
                                    Année
                                    <span class="fr-hint-text">Exemple : 1984</span>
                                </label>
                                <input class="fr-input" name="year" autocomplete="bday-year" id="date-error-4834-bday-year" type="text">
                            </div>
                        </div>
                        <div class="fr-messages-group" id="date-error-4834-messages" aria-live="assertive">
                            <p class="fr-message fr-message--error" id="date-error-4834-message-error">La date est postérieure à aujourd’hui</p>
                        </div>
                    </fieldset>
                </div>
            </div>
            <div class="fr-grid-row fr-mb-6v">
                <div class="fr-col-12">
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4836">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4836">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset fr-fieldset--error" id="date-error-4835" role="group" aria-labelledby="date-error-4835-legend date-error-4835-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="date-error-4835-legend"&gt;
        Date de naissance
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--number"&gt;
        &lt;div class="fr-input-group"&gt;
            &lt;label class="fr-label" for="date-error-4835-bday-day"&gt;
                Jour
                &lt;span class="fr-hint-text"&gt;Exemple : 14&lt;/span&gt;
            &lt;/label&gt;
            &lt;input class="fr-input" name="day" autocomplete="bday-day" id="date-error-4835-bday-day" type="text"&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    &lt;div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--number"&gt;
        &lt;div class="fr-input-group"&gt;
            &lt;label class="fr-label" for="date-error-4835-bday-month"&gt;
                Mois
                &lt;span class="fr-hint-text"&gt;Exemple : 12&lt;/span&gt;
            &lt;/label&gt;
            &lt;input class="fr-input" name="month" autocomplete="bday-month" id="date-error-4835-bday-month" type="text"&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    &lt;div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--inline-grow fr-fieldset__element--year"&gt;
        &lt;div class="fr-input-group"&gt;
            &lt;label class="fr-label" for="date-error-4835-bday-year"&gt;
                Année
                &lt;span class="fr-hint-text"&gt;Exemple : 1984&lt;/span&gt;
            &lt;/label&gt;
            &lt;input class="fr-input" name="year" autocomplete="bday-year" id="date-error-4835-bday-year" type="text"&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    &lt;div class="fr-messages-group" id="date-error-4835-messages" aria-live="assertive"&gt;
        &lt;p class="fr-message fr-message--error" id="date-error-4835-message-error"&gt;La date est postérieure à aujourd’hui&lt;/p&gt;
    &lt;/div&gt;
&lt;/fieldset&gt;
</code></pre>
                            </div>
